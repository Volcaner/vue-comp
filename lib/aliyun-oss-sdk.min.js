    ...
    return function t(e, r, n) {
        ...
        2: [function(t, e, r) {
            (function(r, n) {
                ...
                function o(t, e) {
                    ...
                    this.options.urllib ? this.urllib = this.options.urllib : (this.urllib = k,
                    this.agent = this.options.agent || N),
                    this.ctx = e,
                ...
                function s(t) {
                    var e = x.parse(t);
                    if (e.protocol || (e = x.parse("http://" + t)),
                ...
                o.initOptions = function(t) {
                    ...
                    for (var r in t)
                        void 0 !== t[r] && (e[r] = t[r]);
                    if (e.accessKeyId = e.accessKeyId.trim(),
                    e.accessKeySecret = e.accessKeySecret.trim(),
                    e.timeout && (e.timeout = g(e.timeout)),
                    e.endpoint)
                        e.endpoint = s(e.endpoint);
                    else {
                        if (!e.region)
                ...
                L.authorization = function(t, e, r, n) {
                    ...
                    for (var s in n) {
                        ...
                        0 === c.indexOf("x-oss-") && (o[c] = o[c] || [],
                        o[c].push(String(n[s]).trim()))
                    }
                    var u = [];
                    (0,
                    f.default)(o).sort().forEach(function(t) {
                        u.push(t + ":" + o[t].join(","))
                    }),
                    i = i.concat(u);
                    var l = "";
                ...
                L.createRequest = function(t) {
                    ...
                    v(t.headers).to(e),
                    a(e, "Content-Type") || (t.mime === y.default_type && (t.mime = ""),
                    t.mime && t.mime.indexOf("/") > 0 ? e["Content-Type"] = t.mime : e["Content-Type"] = y.getType(t.mime || m.extname(t.object || "")) || "application/octet-stream"),
                    t.content && (e["Content-Md5"] = h.createHash("md5").update(new n(t.content,"utf8")).digest("base64"),
                ...
                ,
                L.request = l.default.mark(function t(e) {
                    var r, n, i, o;
                ...
                ,
                L.requestError = l.default.mark(function t(e) {
                    var r, n, i;
                    return l.default.wrap(function(t) {
                        for (; ; )
                            switch (t.prev = t.next) {
                            case 0:
                                ...
                                -1 === e.status || -2 === e.status ? (r = new Error(e.message),
                                r.name = e.name,
                                r.status = e.status,
                                r.code = e.name) : (404 === e.status ? (r = new Error("Object not exists"),
                                r.name = "NoSuchKeyError",
                                r.status = 404,
                                r.code = "NoSuchKey") : 412 === e.status ? (r = new Error("Pre condition failed"),
                                r.name = "PreconditionFailedError",
                                r.status = 412,
                                r.code = "PreconditionFailed") : (r = new Error("Unknow error, status: " + e.status),
                                r.name = "UnknowError",
                                r.status = e.status),
        ...
        3: [function(t, e, r) {
            (function(e) {
                    ...
                    return c.default.wrap(function(t) {
                        for (; ; )
                            ...
                            case 29:
                                if (l = t.sent,
                                h = l.uploadId,
                                m = this._getPartSize(a, n.partSize),
                                v = {
                                    file: r,
                                    name: e,
                                    fileSize: a,
                    ...
                    return c.default.wrap(function(t) {
                        for (; ; )
                            ...
                            case 0:
                                ...
                                u = e.doneParts,
                                l = e.name,
                                p = this._divideParts(i, o),
                                f = p.length,
                                h = c.default.mark(function t(i, o) {
                                    var a, d, h;
                                    return c.default.wrap(function(t) {
                                        for (; ; )
                                            switch (t.prev = t.next) {
                                ...
                                m = (0,
                                a.default)(new Array(f), function(t, e) {
                                    return e + 1
                                }),
                                v = u.map(function(t) {
                                    return t.number
                ...
                h.listUploads = c.default.mark(function t(e, r) {
                    var n, i, o;
                    return c.default.wrap(function(t) {
                        for (; ; )
                            switch (t.prev = t.next) {
                ...
                h.abortMultipartUpload = c.default.mark(function t(e, r, n) {
                    var i, o;
                    return c.default.wrap(function(t) {
                        for (; ; )
                            switch (t.prev = t.next) {
                ...
                h._initMultipartUpload = c.default.mark(function t(e, r) {
                    var n, i;
                    return c.default.wrap(function(t) {
                        for (; ; )
                            switch (t.prev = t.next) {
                ...
                h._uploadPart = c.default.mark(function t(e, r, n, i, o) {
                    var a, s;
                    return c.default.wrap(function(t) {
                        for (; ; )
                            switch (t.prev = t.next) {
                ...
                h._completeMultipartUpload = c.default.mark(function t(e, r, n, i) {
                    var o, a, s, u, l, p;
                    return c.default.wrap(function(t) {
                        for (; ; )
                            switch (t.prev = t.next) {
                ...
                i.prototype._read = function(t) {
                    if (this.file && this.start >= this.file.size || this.fileBuffer && this.start >= this.fileBuffer.length || this.finish || 0 == this.start && !this.file)
                        return this.finish || (this.fileBuffer = null,
                        this.finish = !0),
                        void this.push(null);
                    t = t || 16384;
                    var r = this;
        ...
        4: [function(t, e, r) {
            ...
            var n = t("babel-runtime/regenerator")
              ...
              , f = t("mime")
              , d = r;
            d.append = i.default.mark(function t(e, r, n) {
                var o;
            ...
            d.put = i.default.mark(function t(e, r, n) {
                var o, a, u, l, d, h;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
            ...
            d.putStream = i.default.mark(function t(e, r, n) {
                var o, a, s, c;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
            ...
            d.head = i.default.mark(function t(e, r) {
                var n, o, a, s;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        ...
                        case 4:
                            ...
                            200 === o.status)
                                for (s in o.headers)
                                    0 === s.indexOf("x-oss-meta-") && (a.meta || (a.meta = {}),
                                    a.meta[s.substring(11)] = o.headers[s]);
            ...
            d.get = i.default.mark(function t(e, r, n) {
                var a, u, l, p;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return a = null,
                            u = !1,
                            c.writableStream(r) ? a = r : c.string(r) ? (a = s.createWriteStream(r),
                            u = !0) : n = r,
                            n = n || {},
            ...
            d.getStream = i.default.mark(function t(e, r) {
                var n, o;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
            ...
            d.delete = i.default.mark(function t(e, r) {
                var n, o;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
            ...
            d.deleteMulti = i.default.mark(function t(e, r) {
                var n, s, c, u, l, p;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            ...
                            s = 0; s < e.length; s++)
                                n += "  <Object><Key>" + a.escape(this._objectName(e[s])) + "</Key></Object>\n";
                            return n += "</Delete>",
            ...
            d.copy = i.default.mark(function t(e, r, n) {
                var o, a, s, c;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            ...
                            n.headers = n.headers || {};
                            for (o in n.headers)
                                n.headers["x-oss-copy-source-" + o.toLowerCase()] = n.headers[o];
            ...
            d.putMeta = i.default.mark(function t(e, r, n) {
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
            ...
            d.list = i.default.mark(function t(e, r) {
                var n, o, a, s, c;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
            ...
            d.putACL = i.default.mark(function t(e, r, n) {
                var o, a;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
            ...
            d.getACL = i.default.mark(function t(e, r) {
                var n, o;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
            ...
            d.signatureUrl = function(t, e) {
                ...
                if (this.options.stsToken && (o["security-token"] = this.options.stsToken,
                s.push("security-token=" + this.options.stsToken)),
                e.process) {
        ...
        9: [function(t, e, r) {
            ...
            e.exports = function(t, e) {
                return function(r, i) {
                    ...
                    i = i || {};
                    var o = !1 !== i.global;
                    if (null === n && o && (n = t["@@any-promise/REGISTRATION"] || null),
                    null !== n && null !== r && n.implementation !== r)
                        throw new Error('any-promise already defined as "' + n.implementation + '".  You can only register an implementation before the first  call to require("any-promise") and an implementation cannot be changed');
        ...
        28: [function(t, e, r) {
            ...
            function o(t) {
                ...
                a[c++] = 255 & i) : 1 === o && (i = l[t.charCodeAt(e)] << 10 | l[t.charCodeAt(e + 1)] << 4 | l[t.charCodeAt(e + 2)] >> 2,
                a[c++] = i >> 8 & 255,
                a[c++] = 255 & i),
                a
            }
            ...
            function c(t) {
                for (var e, r = t.length, n = r % 3, i = "", o = [], a = 0, c = r - n; a < c; a += 16383)
                    o.push(s(t, a, a + 16383 > c ? c : a + 16383));
                return 1 === n ? (e = t[r - 1],
                i += u[e >> 2],
                i += u[e << 4 & 63],
            ...
            r.toByteArray = o,
            r.fromByteArray = c;
            for (var u = [], l = [], p = "undefined" != typeof Uint8Array ? Uint8Array : Array, f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", d = 0, h = f.length; d < h; ++d)
                u[d] = f[d],
                l[f.charCodeAt(d)] = d;
            l["-".charCodeAt(0)] = 62,
            l["_".charCodeAt(0)] = 63
        ...
        29: [function(e, r, n) {
            !function(e, n, i) {
                ...
                function t(t) {
                    ...
                    var n, i = e(/(ipod|iphone|ipad)/i).toLowerCase(), o = /like android/i.test(t), s = !o && /android/i.test(t), c = /nexus\s*[0-6]\s*/i.test(t), u = !c && /nexus\s*[0-9]+/i.test(t), l = /CrOS/.test(t), p = /silk/i.test(t), f = /sailfish/i.test(t), d = /tizen/i.test(t), h = /(web|hpw)os/i.test(t), m = /windows phone/i.test(t), v = (/SamsungBrowser/i.test(t),
                    !m && /windows/i.test(t)), y = !i && !p && /macintosh/i.test(t), b = !s && !f && !d && !h && /linux/i.test(t), g = r(/edg([ea]|ios)\/(\d+(\.\d+)?)/i), w = e(/version\/(\d+(\.\d+)?)/i), _ = /tablet/i.test(t) && !/tablet pc/i.test(t), x = !_ && /[^-]mobi/i.test(t), E = /xbox/i.test(t);
                    /opera/i.test(t) ? n = {
                        name: "Opera",
                        opera: a,
                    ...
                    n.version = e(/iemobile\/(\d+(\.\d+)?)/i))) : /msie|trident/i.test(t) ? n = {
                    ...
                    /\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(t) && (n.firefoxos = a,
                    n.osname = "Firefox OS")) : p ? n = {
                        name: "Amazon Silk",
                        silk: a,
                    ...
                    n.webkit = a),
                    !n.version && w && (n.version = w)) : !n.opera && /gecko\//i.test(t) && (n.name = n.name || "Gecko",
                    n.gecko = a,
                    n.version = n.version || e(/gecko\/(\d+(\.\d+)?)/i)),
                    n.windowsphone || !s && !n.silk ? !n.windowsphone && i ? (n[i] = a,
                    n.ios = a,
                    n.osname = "iOS") : y ? (n.mac = a,
                    n.osname = "macOS") : E ? (n.xbox = a,
                    n.osname = "Xbox") : v ? (n.windows = a,
                    n.osname = "Windows") : b && (n.linux = a,
                    n.osname = "Linux") : (n.android = a,
                    n.osname = "Android");
                    var S = "";
                    ...
                    }(e(/Windows ((NT|XP)( \d\d?.\d)?)/i)) : n.windowsphone ? S = e(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i) : n.mac ? (S = e(/Mac OS X (\d+([_\.\s]\d+)*)/i),
                    S = S.replace(/[_\s]/g, ".")) : i ? (S = e(/os (\d+([_\s]\d+)*) like mac os x/i),
                    S = S.replace(/[_\s]/g, ".")) : s ? S = e(/android[ \/-](\d+(\.\d+)*)/i) : n.webos ? S = e(/(?:web|hpw)os\/(\d+(\.\d+)*)/i) : n.blackberry ? S = e(/rim\stablet\sos\s(\d+(\.\d+)*)/i) : n.bada ? S = e(/bada\/(\d+(\.\d+)*)/i) : n.tizen && (S = e(/tizen[\/\s](\d+(\.\d+)*)/i)),
                    S && (n.osversion = S);
        ...
        31: [function(t, e, r) {
            (function(e) {
                ...
                function f(t, e, r, n) {
                    ...
                    t.__proto__ = o.prototype) : t = p(t, e),
                    t
                }
                function d(t, e) {
                    if (o.isBuffer(e)) {
        ...
        34: [function(t, e, r) {
            ...
            var n = t("babel-runtime/regenerator")
              ...
              , o = t("co-thread");
            e.exports = i.default.mark(function t(e, r) {
                var n, a, s, c;
                return i.default.wrap(function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
        ...
        36: [function(t, e, r) {
            function n(t) {
                ...
                return new Promise(function(n, o) {
                    ...
                    if ("function" == typeof t && (t = t.apply(e, r)),
        ...
        66: [function(t, e, r) {
            var n = t("./_global")
              ...
              , a = t("./_hide")
              , s = function(t, e, r) {
                var c, u, l, p = t & s.F, f = t & s.G, d = t & s.S, h = t & s.P, m = t & s.B, v = t & s.W, y = f ? i : i[e] || (i[e] = {}), b = y.prototype, g = f ? n : d ? n[e] : (n[e] || {}).prototype;
                f && (r = e);
                for (c in r)
                    (u = !p && g && void 0 !== g[c]) && c in y || (l = u ? g[c] : r[c],
                    y[c] = f && "function" != typeof g[c] ? r[c] : m && u ? o(l, n) : v && g[c] == l ? function(t) {
        ...
        80: [function(t, e, r) {
            ...
            e.exports = function(t, e, r, m, v, y, b) {
                ...
                }, E = e + " Iterator", S = "values" == v, T = !1, k = t.prototype, O = k[f] || k["@@iterator"] || v && k[v], j = O || x(v), A = v ? S ? x("entries") : j : void 0, N = "Array" == e ? k.entries || O : O;
                if (N && (_ = p(N.call(new t))) !== Object.prototype && _.next && (l(_, E, !0),
                n || s(_, f) || a(_, f, h)),
                S && O && "values" !== O.name && (T = !0,
                j = function() {
                    return O.call(this)
                }
                ),
        ...
        86: [function(t, e, r) {
            ...
            e.exports = !c || t("./_fails")(function() {
                ...
                for (var r = a(t), c = arguments.length, u = 1, l = i.f, p = o.f; c > u; )
                    for (var f, d = s(arguments[u++]), h = l ? n(d).concat(l(d)) : n(d), m = h.length, v = 0; m > v; )
        ...
        105: [function(t, e, r) {
            var n, i, o, a = t("./_ctx"), s = t("./_invoke"), c = t("./_html"), u = t("./_dom-create"), l = t("./_global"), p = l.process, f = l.setImmediate, d = l.clearImmediate, h = l.MessageChannel, m = l.Dispatch, v = 0, y = {}, b = function() {
                var t = +this;
        ...
        117: [function(t, e, r) {
            ...
            i(i.S + i.F * !t("./_iter-detect")(function(t) {
                ...
                from: function(t) {
                    var e, r, i, p, f = o(t), d = "function" == typeof this ? this : Array, h = arguments.length, m = h > 1 ? arguments[1] : void 0, v = void 0 !== m, y = 0, b = l(f);
                    if (v && (m = n(m, h > 2 ? arguments[2] : void 0, 2)),
                    void 0 == b || d == Array && s(b))
                        ...
                        for (p = b.call(f),
                        r = new d; !(i = p.next()).done; y++)
                            u(r, y, v ? a(p, m, [i.value, y], !0) : i.value);
                    return r.length = y,
                    r
                }
            })
        ...
        118: [function(t, e, r) {
            ...
            e.exports = t("./_iter-define")(Array, "Array", function(t, e) {
                ...
                i(1)) : "keys" == e ? i(0, r) : "values" == e ? i(0, t[r]) : i(0, [r, t[r]])
            }, "values"),
            o.Arguments = o.Array,
            n("keys"),
            n("values"),
        ...
        129: [function(t, e, r) {
            ...
            : j
              ...
              , H = F && "symbol" == typeof N.iterator ? function(t) {
            ...
            : function(t) {
              ...
              , W = function(t, e, r) {
                ...
                e = w(e, !0),
                b(r),
                i(R, e) ? (r.enumerable ? (i(t, D) && t[D][e] && (t[D][e] = !1),
                r = x(r, {
                    enumerable: _(0, !1)
                })) : (i(t, D) || j(t, D, _(1, {})),
                t[D][e] = !0),
              ...
              , Y = function(t, e) {
                b(t);
                for (var r, n = v(e = g(e)), i = 0, o = n.length; o > i; )
                    W(t, r = n[i++], e[r]);
                return t
            }
              , V = function(t, e) {
              ...
              , Q = function(t) {
                for (var e, r = A(g(t)), n = [], o = 0; r.length > o; )
                    i(R, e = r[o++]) || e == D || e == c || n.push(e);
                return n
            }
              , J = function(t) {
                for (var e, r = t === B, n = A(r ? U : g(t)), o = [], a = 0; n.length > a; )
                    !i(R, e = n[a++]) || r && !i(B, e) || o.push(R[e]);
                return o
            };
            F || (N = function() {
                if (this instanceof N)
            ...
            t("./_object-pie").f = K,
            t("./_object-gops").f = J,
            o && !t("./_library") && s(B, "propertyIsEnumerable", K, !0),
            h.f = function(t) {
                return z(d(t))
            }
            ),
            ...
            for (var Z = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), tt = 0; Z.length > tt; )
                d(Z[tt++]);
            for (var et = k(d.store), rt = 0; et.length > rt; )
                m(et[rt++]);
            a(a.S + a.F * !F, "Symbol", {
                for: function(t) {
        ...
        134: [function(t, e, r) {
            (function(e) {
                ...
                function v(t) {
                    return null === t || "boolean" == typeof t || "number" == typeof t || "string" == typeof t || "symbol" === (void 0 === t ? "undefined" : (0,
                    g.default)(t)) || void 0 === t
                }
                function y(t) {
        ...
        136: [function(t, e, r) {
            function n(t, e, r) {
                ...
                for (var n = new a(f), i = new a(f), o = 0; o < f; o++)
                    n[o] = 54 ^ e[o],
                    i[o] = 92 ^ e[o];
        ...
        138: [function(t, e, r) {
            !function() {
                var t, r, n = this;
                t = function(t) {
                    for (var e, e, r = new Array(t), n = 0; n < t; n++)
        ...
        139: [function(t, e, r) {
            function n(t, e) {
                ...
                for (var r = Array(80), n = 1732584193, c = -271733879, u = -1732584194, l = 271733878, p = -1009589776, f = 0; f < t.length; f += 16) {
                    for (var d = n, h = c, m = u, v = l, y = p, b = 0; b < 80; b++) {
            ...
            var n = t("./helpers")
              ...
              , d = function(t, e) {
                ...
                for (var y = 0; y < t.length; y += 16) {
                    ...
                    v = x[7];
                    for (var b = 0; b < 64; b++)
                        E[b] = b < 16 ? t[b + y] : i(i(i(f(E[b - 2]), E[b - 7]), p(E[b - 15])), E[b - 16]),
        ...
        141: [function(e, r, n) {
            ...
            !function(e) {
                ...
                function c(t) {
                    return null === t ? "null" : void 0 === t ? "undefined" : "object" !== (void 0 === t ? "undefined" : (0,
                    o.default)(t)) ? void 0 === t ? "undefined" : (0,
                    o.default)(t) : Array.isArray(t) ? "array" : {}.toString.call(t).slice(8, -1).toLowerCase()
                }
                var u = function() {
                    ...
                    return function(n, o, l, p) {
                        if (1 !== arguments.length || "string" !== c(n) || /\d/.test(n) || (o = n,
                        n = void 0),
                        n = n || new Date,
                ...
                o.default)(n)) ? r.exports = u : e.dateFormat = u
            }(void 0)
        }
        , {
            "babel-runtime/helpers/typeof": 26
        ...
        142: [function(t, e, r) {
            (function(n) {
                ...
                function o(t) {
                    ...
                    if (t[0] = (e ? "%c" : "") + this.namespace + (e ? " %c" : " ") + t[0] + (e ? "%c " : " ") + "+" + r.humanize(this.diff),
                    e) {
        ...
        145: [function(t, e, r) {
            ...
            n.prototype.addListener = function(t, e) {
                ...
                a(this._events[t]) && !this._events[t].warned && (r = s(this._maxListeners) ? n.defaultMaxListeners : this._maxListeners) && r > 0 && this._events[t].length > r && (this._events[t].warned = !0,
        ...
        148: [function(t, e, r) {
            r.read = function(t, e, r, n, i) {
                var o, a, s = 8 * i - n - 1, c = (1 << s) - 1, u = c >> 1, l = -7, p = r ? i - 1 : 0, f = r ? -1 : 1, d = t[e + p];
                for (p += f,
                o = d & (1 << -l) - 1,
                d >>= -l,
                l += s; l > 0; o = 256 * o + t[e + p],
                p += f,
                l -= 8)
                    ;
                for (a = o & (1 << -l) - 1,
                o >>= -l,
                l += n; l > 0; a = 256 * a + t[e + p],
                p += f,
                l -= 8)
                    ;
                if (0 === o)
            ...
            r.write = function(t, e, r, n, i, o) {
                var a, s, c, u = 8 * o - i - 1, l = (1 << u) - 1, p = l >> 1, f = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, d = n ? 0 : o - 1, h = n ? 1 : -1, m = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
                for (e = Math.abs(e),
                ...
                c /= 2),
                a + p >= l ? (s = 0,
                a = l) : a + p >= 1 ? (s = (e * c - 1) * Math.pow(2, i),
                a += p) : (s = e * Math.pow(2, p - 1) * Math.pow(2, i),
                a = 0)); i >= 8; t[r + d] = 255 & s,
                d += h,
                s /= 256,
                i -= 8)
        ...
        151: [function(e, r, n) {
            !function(e) {
                ...
                void 0 !== n ? (void 0 !== r && r.exports && (n = r.exports = o),
                n.isClass = o) : "function" == typeof t && t.amd ? t([], function() {
                    return o
                }) : e.isClass = o
            }(this)
        }
            ...
            (function(e) {
                (function() {
                    ...
                    function h(t) {
                        function e(e) {
                            return f(e, function(e, r) {
                                var n = r.pattern || p(r);
                                return !e && (e = RegExp("\\b" + n + " *\\d+[.\\w_]*", "i").exec(t) || RegExp("\\b" + n + " *\\w+-[\\w]*", "i").exec(t) || RegExp("\\b" + n + "(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)", "i").exec(t)) && ((e = String(r.label && !RegExp(n, "i").test(r.label) ? r.label : e).split("/"))[1] && !/[\d.]+/.test(e[0]) && (e[0] += " " + e[1]),
                                r = r.label || r,
                                e = s(e[0].replace(RegExp(n, "i"), r).replace(RegExp("; *(?:" + r + "[_-])?", "i"), " ").replace(RegExp("(" + r + ")[-_.]?(\\w)", "i"), "$1 $2"))),
                                e
                            })
                        }
                        function r() {
                        ...
                        var b, g, w = i || E == y, _ = i ? !!a.likeChrome : /\bChrome\b/.test(t) && !/internal|\n/i.test(k.toString()), S = i ? "Object" : "ScriptBridgingProxyObject", T = i ? "Object" : "Environment", O = i && n.java ? "JavaPackage" : u(n.java), j = i ? "Object" : "RuntimeObject", A = /\bJava/.test(O) && n.java, N = A && u(n.environment) == T, L = A ? "a" : "α", I = A ? "b" : "β", D = n.document || {}, C = n.operamini || n.opera, M = x.test(M = i && C ? C["[[Class]]"] : u(C)) ? M : C = null, P = t, R = [], U = null, B = t == m, F = B && C && "function" == typeof C.version && C.version(), q = function(e) {
                            ...
                            label: "WebKit",
                            pattern: "AppleWebKit"
                        }, "iCab", "Presto", "NetFront", "Tasman", "KHTML", "Gecko"]), X = function(e) {
                            return f(e, function(e, r) {
                                return e || RegExp("\\b" + (r.pattern || p(r)) + "\\b", "i").exec(t) && (r.label || r)
                            })
                        ...
                        if (q && (q = [q]),
                        z && !G && (G = e([z])),
                        (b = /\bGoogle TV\b/.exec(G)) && (G = b[0]),
                        /\bSimulator\b/i.test(t) && (G = (G ? G + " " : "") + "Simulator"),
                        "Opera Mini" == X && /\bOPiOS\b/.test(t) && R.push("running in Turbo/Uncompressed mode"),
                        "IE" == X && /\blike iPhone OS\b/.test(t) ? (b = h(t.replace(/like iPhone OS/, "")),
                        z = b.manufacturer,
                        G = b.product) : /^iP/.test(G) ? (X || (X = "Safari"),
                        H = "iOS" + ((b = / OS ([\d_]+)/i.exec(t)) ? " " + b[1].replace(/_/g, ".") : "")) : "Konqueror" != X || /buntu/i.test(H) ? z && "Google" != z && (/Chrome/.test(X) && !/\bMobile Safari\b/i.test(t) || /\bVita\b/.test(G)) || /\bAndroid\b/.test(H) && /^Chrome/.test(X) && /\bVersion\//i.test(t) ? (X = "Android Browser",
                        H = /\bAndroid\b/.test(H) ? H : "Android") : "Silk" == X ? (/\bMobi/i.test(t) || (H = "Android",
                        R.unshift("desktop mode")),
                        /Accelerated *= *true/i.test(t) && R.unshift("accelerated")) : "PaleMoon" == X && (b = /\bFirefox\/([\d.]+)\b/.exec(t)) ? R.push("identifying as Firefox " + b[1]) : "Firefox" == X && (b = /\b(Mobile|Tablet|TV)\b/i.exec(t)) ? (H || (H = "Firefox OS"),
                        G || (G = b[1])) : !X || (b = !/\bMinefield\b/i.test(t) && /\b(?:Firefox|Safari)\b/.exec(X)) ? (X && !G && /[\/,]|^[^(]+?\)/.test(t.slice(t.indexOf(b + "/") + 8)) && (X = null),
                        (b = G || z || H) && (G || z || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(H)) && (X = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(H) ? H : b) + " Browser")) : "Electron" == X && (b = (/\bChrome\/([\d.]+)\b/.exec(t) || 0)[1]) && R.push("Chromium " + b) : H = "Kubuntu",
                        F || (F = function(e) {
                            return f(e, function(e, r) {
                                return e || (RegExp(r + "(?:-[\\d.]+/|(?: for [\\w-]+)?[ /-])([\\d.]+[^ ();/_-]*)", "i").exec(t) || 0)[1] || null
                            })
                        }(["(?:Cloud9|CriOS|CrMo|Edge|FxiOS|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$))", "Version", p(X), "(?:Firefox|Minefield|NetFront)"])),
                        (b = "iCab" == q && parseFloat(F) > 3 && "WebKit" || /\bOpera\b/.test(X) && (/\bOPR\b/.test(t) ? "Blink" : "Presto") || /\b(?:Midori|Nook|Safari)\b/i.test(t) && !/^(?:Trident|EdgeHTML)$/.test(q) && "WebKit" || !q && /\bMSIE\b/i.test(t) && ("Mac OS" == H ? "Tasman" : "Trident") || "WebKit" == q && /\bPlayStation\b(?! Vita\b)/i.test(X) && "NetFront") && (q = [b]),
                        "IE" == X && (b = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(t) || 0)[1]) ? (X += " Mobile",
                        H = "Windows Phone " + (/\+$/.test(b) ? b : b + ".x"),
                        R.unshift("desktop mode")) : /\bWPDesktop\b/i.test(t) ? (X = "IE Mobile",
                        H = "Windows Phone 8.x",
                        R.unshift("desktop mode"),
                        F || (F = (/\brv:([\d.]+)/.exec(t) || 0)[1])) : "IE" != X && "Trident" == q && (b = /\brv:([\d.]+)/.exec(t)) && (X && R.push("identifying as " + X + (F ? " " + F : "")),
                        X = "IE",
                        F = b[1]),
                        B) {
                            if (l(n, "global"))
                                if (A && (b = A.lang.System,
                                P = b.getProperty("os.arch"),
                                H = H || b.getProperty("os.name") + " " + b.getProperty("os.version")),
                                w && l(n, "system") && (b = [n.system])[0]) {
                                    H || (H = b[0].os || null);
                                    try {
                                    ...
                                    "object" == typeof n.process && !n.process.browser && (b = n.process) ? "object" == typeof b.versions ? "string" == typeof b.versions.electron ? (R.push("Node " + b.versions.node),
                                    X = "Electron",
                                    F = b.versions.electron) : "string" == typeof b.versions.nw && (R.push("Chromium " + F, "Node " + b.versions.node),
                                    X = "NW.js",
                                    F = b.versions.nw) : (X = "Node.js",
                                    P = b.arch,
                                    H = b.platform,
                                    F = /[\d.]+/.exec(b.version),
                                    F = F ? F[0] : "unknown") : N && (X = "Rhino");
                            else
                                u(b = n.runtime) == S ? (X = "Adobe AIR",
                                H = b.flash.system.Capabilities.os) : u(b = n.phantom) == j ? (X = "PhantomJS",
                                F = (b = b.version || null) && b.major + "." + b.minor + "." + b.patch) : "number" == typeof D.documentMode && (b = /\bTrident\/(\d+)/i.exec(t)) ? (F = [F, D.documentMode],
                                (b = +b[1] + 4) != F[1] && (R.push("IE " + F[1] + " mode"),
                                q && (q[1] = ""),
                                F[1] = b),
                                F = "IE" == X ? String(F[1].toFixed(1)) : F[0]) : "number" == typeof D.documentMode && /^(?:Chrome|Firefox)\b/.test(X) && (R.push("masking as " + X + " " + F),
                                X = "IE",
                                F = "11.0",
                                q = ["Trident"],
                                H = "Windows");
                        ...
                        if (F && (b = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(F) || /(?:alpha|beta)(?: ?\d)?/i.exec(t + ";" + (B && a.appMinorVersion)) || /\bMinefield\b/i.test(t) && "a") && (U = /b/i.test(b) ? "beta" : "alpha",
                        F = F.replace(RegExp(b + "\\+?$"), "") + ("beta" == U ? I : L) + (/\d+\+?/.exec(b) || "")),
                        "Fennec" == X || "Firefox" == X && /\b(?:Android|Firefox OS)\b/.test(H))
                            X = "Firefox Mobile";
                        else if ("Maxthon" == X && F)
                            F = F.replace(/\.[\d.]+/, ".x");
                        ...
                        else if (!/^(?:Chrome|IE|Opera)$/.test(X) && (!X || G || /Browser|Mobi/.test(X)) || "Windows CE" != H && !/Mobi/i.test(t))
                            if ("IE" == X && B)
                                try {
                                ...
                                (/\bBlackBerry\b/.test(G) || /\bBB10\b/.test(t)) && (b = (RegExp(G.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(t) || 0)[1] || F) ? (b = [b, /BB10/.test(t)],
                                H = (b[1] ? (G = null,
                                z = "BlackBerry") : "Device Software") + " " + b[0],
                                F = null) : this != c && "Wii" != G && (B && C || /Opera/.test(X) && /\b(?:MSIE|Firefox)\b/i.test(t) || "Firefox" == X && /\bOS X (?:\d+\.){2,}/.test(H) || "IE" == X && (H && !/^Win/.test(H) && F > 5.5 || /\bWindows XP\b/.test(H) && F > 8 || 8 == F && !/\bTrident\b/.test(t))) && !x.test(b = h.call(c, t.replace(x, "") + ";")) && b.name && (b = "ing as " + b.name + ((b = b.version) ? " " + b : ""),
                                x.test(X) ? (/\bIE\b/.test(b) && "Mac OS" == H && (H = null),
                                b = "identify" + b) : (b = "mask" + b,
                                X = M ? s(M.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera",
                                /\bIE\b/.test(b) && (H = null),
                                B || (F = null)),
                                q = ["Presto"],
                                R.push(b));
                            ...
                            X += " Mobile";
                        (b = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(t) || 0)[1]) && (b = [parseFloat(b.replace(/\.(\d)$/, ".0$1")), b],
                        "Safari" == X && "+" == b[1].slice(-1) ? (X = "WebKit Nightly",
                        U = "alpha",
                        F = b[1].slice(0, -1)) : F != b[1] && F != (b[2] = (/\bSafari\/([\d.]+\+?)/i.exec(t) || 0)[1]) || (F = null),
                        b[1] = (/\bChrome\/([\d.]+)/i.exec(t) || 0)[1],
                        537.36 == b[0] && 537.36 == b[2] && parseFloat(b[1]) >= 28 && "WebKit" == q && (q = ["Blink"]),
                        B && (_ || b[1]) ? (q && (q[1] = "like Chrome"),
                        b = b[1] || (b = b[0],
                        b < 530 ? 1 : b < 532 ? 2 : b < 532.05 ? 3 : b < 533 ? 4 : b < 534.03 ? 5 : b < 534.07 ? 6 : b < 534.1 ? 7 : b < 534.13 ? 8 : b < 534.16 ? 9 : b < 534.24 ? 10 : b < 534.3 ? 11 : b < 535.01 ? 12 : b < 535.02 ? "13+" : b < 535.07 ? 15 : b < 535.11 ? 16 : b < 535.19 ? 17 : b < 536.05 ? 18 : b < 536.1 ? 19 : b < 537.01 ? 20 : b < 537.11 ? "21+" : b < 537.13 ? 23 : b < 537.18 ? 24 : b < 537.24 ? 25 : b < 537.36 ? 26 : "Blink" != q ? "27" : "28")) : (q && (q[1] = "like Safari"),
                        b = b[0],
                        b = b < 400 ? 1 : b < 500 ? 2 : b < 526 ? 3 : b < 533 ? 4 : b < 534 ? "4+" : b < 535 ? 5 : b < 537 ? 6 : b < 538 ? 7 : b < 601 ? 8 : "8"),
                        q && (q[1] += " " + (b += "number" == typeof b ? ".x" : /[.+]/.test(b) ? "" : "+")),
                        "Safari" == X && (!F || parseInt(F) > 45) && (F = b)),
                        "Opera" == X && (b = /\bzbov|zvav$/.exec(H)) ? (X += " ",
                        R.unshift("desktop mode"),
                        "zvav" == b ? (X += "Mini",
                        F = null) : X += "Mobile",
                        H = H.replace(RegExp(" *" + b + "$"), "")) : "Safari" == X && /\bChrome\b/.exec(q && q[1]) && (R.unshift("desktop mode"),
                        X = "Chrome Mobile",
                        F = null,
                        /\bOS X\b/.test(H) ? (z = "Apple",
                        H = "iOS 4.3+") : H = null),
                        ...
                        H && (b = / ([\d.+]+)$/.exec(H),
                        g = b && "/" == H.charAt(H.length - b[0].length - 1),
                        H = {
                            architecture: 32,
                        ...
                        (b = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(P)) && !/\bi686\b/i.test(P) ? (H && (H.architecture = 64,
                        H.family = H.family.replace(RegExp(" *" + b), "")),
                        X && (/\bWOW64\b/i.test(t) || B && /\w(?:86|32)$/.test(a.cpuClass || a.platform) && !/\bWin64; x64\b/i.test(t)) && R.unshift("32-bit")) : H && /^OS X/.test(H.family) && "Chrome" == X && parseFloat(F) >= 39 && (H.architecture = 64),
                        t || (t = null);
                        var W = {};
                    ...
                    var _ = Math.pow(2, 53) - 1
                      ...
                      , k = S.toString
                      , O = h();
                    "function" == typeof t && "object" == typeof t.amd && t.amd ? (v.platform = O,
                    t(function() {
                        return O
                    })) : b && g ? c(O, function(t, e) {
                        b[e] = t
                    }) : v.platform = O
                }
                ).call(this)
        ...
        160: [function(e, r, n) {
            (function(e) {
                !function(i) {
                    ...
                    function d(t) {
                        var e, r, n, i, a, s, c, p, d, h, m = [], v = t.length, y = 0, b = A, g = j;
                        for (r = t.lastIndexOf(N),
                        r < 0 && (r = 0),
                        n = 0; n < r; ++n)
                        ...
                        for (i = r > 0 ? r + 1 : 0; i < v; ) {
                            for (a = y,
                            s = 1,
                            c = E; i >= v && o("invalid-input"),
                            p = l(t.charCodeAt(i++)),
                            (p >= E || p > P((x - y) / s)) && o("overflow"),
                            y += p * s,
                            d = c <= g ? S : c >= g + T ? T : c - g,
                            !(p < d); c += E)
                                h = E - d,
                    ...
                    var w, _, x = 2147483647, E = 36, S = 1, T = 26, k = 38, O = 700, j = 72, A = 128, N = "-", L = /^xn--/, I = /[^\x20-\x7E]/, D = /[\x2E\u3002\uFF0E\uFF61]/g, C = {
                        overflow: "Overflow: input needs wider integers to process",
                        "not-basic": "Illegal input >= 0x80 (not a basic code point)",
                        "invalid-input": "Invalid input"
                    }, M = E - S, P = Math.floor, R = String.fromCharCode;
                    if (w = {
                        version: "1.4.1",
                        ucs2: {
                            decode: c,
        ...
        167: [function(t, e, r) {
            (function(r, n) {
                ...
                function s(e, r) {
                    ...
                    this.decoder = null,
                    this.encoding = null,
                    e.encoding && (z || (z = t("string_decoder/").StringDecoder),
                    this.decoder = new z(e.encoding),
                    this.encoding = e.encoding)
                }
                function c(e) {
                    if (M = M || t("./_stream_duplex"),
                    !(this instanceof c))
                        return new c(e);
                ...
                function u(t, e, r, n, o) {
                    ...
                    if (null === e)
                        ...
                        var s;
                        o || (s = p(a, e)),
                        s ? t.emit("error", s) : a.objectMode || e && e.length > 0 ? ("string" == typeof e || a.objectMode || (0,
                        D.default)(e) === B.prototype || (e = i(e)),
                        n ? a.endEmitted ? t.emit("error", new Error("stream.unshift() after end event")) : l(t, a, e, !0) : a.ended ? t.emit("error", new Error("stream.push() after EOF")) : (a.reading = !1,
                        a.decoder && !r ? (e = a.decoder.write(e),
                        a.objectMode || 0 !== e.length ? l(t, a, e, !1) : b(t, a)) : l(t, a, e, !1))) : n || (a.reading = !1)
                    }
                    return f(a)
                }
                function l(t, e, r, n) {
                ...
                function v(t) {
                    ...
                    e.needReadable = !1,
                    e.emittedReadable || (G("emitReadable", e.flowing),
                    e.emittedReadable = !0,
                    e.sync ? C(y, t) : y(t))
                }
                function y(t) {
                ...
                function g(t, e) {
                    for (var r = e.length; !e.reading && !e.flowing && !e.ended && e.length < e.highWaterMark && (G("maybeReadMore read 0"),
                    t.read(0),
                    r !== e.length); )
                        r = e.length;
                    e.readingMore = !1
                ...
                function w(t) {
                    return function() {
                        ...
                        0 === e.awaitDrain && R(t, "data") && (e.flowing = !0,
                        S(t))
                    }
                }
                function _(t) {
                ...
                function T(t, e) {
                    if (0 === e.length)
                        return null;
                    var r;
                    return e.objectMode ? r = e.buffer.shift() : !t || t >= e.length ? (r = e.decoder ? e.buffer.join("") : 1 === e.buffer.length ? e.buffer.head.data : e.buffer.concat(e.length),
                    e.buffer.clear()) : r = k(t, e.buffer, e.decoder),
                    r
                }
                function k(t, e, r) {
                    var n;
                    return t < e.head.data.length ? (n = e.head.data.slice(0, t),
                    e.head.data = e.head.data.slice(t)) : n = t === e.head.data.length ? e.shift() : r ? O(t, e) : j(t, e),
                    n
                }
                function O(t, e) {
                    var r = e.head
                ...
                c.prototype.read = function(t) {
                    ...
                    0 === t && e.needReadable && (e.length >= e.highWaterMark || e.ended))
                        return G("read: emitReadable", e.length, e.ended),
                    ...
                    G("need readable", n),
                    (0 === e.length || e.length - t < e.highWaterMark) && (n = !0,
                    G("length less than watermark", n)),
                    e.ended || e.reading ? (n = !1,
                    G("reading or ended", n)) : n && (G("do read"),
                    e.reading = !0,
                    e.sync = !0,
                ...
                c.prototype.pipe = function(t, e) {
                    function n(t, e) {
                        G("onunpipe"),
                        t === f && e && !1 === e.hasUnpiped && (e.hasUnpiped = !0,
                        o())
                    }
                    function i() {
                        G("onend"),
                    ...
                    function s(e) {
                        G("ondata"),
                        b = !1,
                        !1 !== t.write(e) || b || ((1 === d.pipesCount && d.pipes === t || d.pipesCount > 1 && -1 !== L(d.pipes, t)) && !y && (G("false write response, pause", f._readableState.awaitDrain),
                ...
                c.prototype.on = function(t, e) {
                    ...
                    if ("data" === t)
                        ...
                        n.emittedReadable = !1,
                        n.reading ? n.length && v(this) : C(_, this))
                    }
                    return r
                }
                ,
                ...
                c.prototype.pause = function() {
                    ...
                    !1 !== this._readableState.flowing && (G("pause"),
        ...
        169: [function(t, e, r) {
            (function(r, n) {
                    ...
                    if (t._writev && r && r.next) {
                        ...
                        for (; r; ) {
                            var u = r.chunk
                              , l = r.encoding
                              , p = r.callback;
                            if (m(t, e, !1, e.objectMode ? 1 : u.length, u, l, p),
                            r = r.next,
                            e.writing)
                                break
                        }
                ...
                e.exports = l;
                var R, U = !r.browser && ["v0.10", "v0.9."].indexOf(r.version.slice(0, 5)) > -1 ? M.default : P;
                l.WritableState = u;
                ...
                var H;
                "function" == typeof D.default && L.default && "function" == typeof Function.prototype[L.default] ? (H = Function.prototype[L.default],
                (0,
                A.default)(l, L.default, {
                    value: function(t) {
                ...
                l.prototype.write = function(t, e, r) {
                    ...
                    n.ended ? p(this, r) : (o || f(this, n, t, r)) && (n.pendingcb++,
                    i = h(this, n, o, t, e, r)),
                    i
                }
                ,
        ...
        171: [function(t, e, r) {
            ...
            function n(t, e) {
                ...
                if (n || i)
                    return void (e ? e(t) : !t || this._writableState && this._writableState.errorEmitted || a(o, this, t));
        ...
        174: [function(t, e, r) {
            ...
            function i(t) {
                var e = n(t);
                if ("string" != typeof e && (b.isEncoding === g || !g(t)))
            ...
            function s(t, e, r) {
                ...
                i) : --n < r ? 0 : (i = a(e[n])) >= 0 ? (i > 0 && (t.lastNeed = i - 2),
                i) : --n < r ? 0 : (i = a(e[n]),
        ...
        180: [function(t, e, r) {
            !function(t) {
                ...
                var v, y = Object.prototype, b = y.hasOwnProperty, g = "function" == typeof Symbol ? Symbol : {}, w = g.iterator || "@@iterator", _ = g.asyncIterator || "@@asyncIterator", x = g.toStringTag || "@@toStringTag", E = "object" == typeof e, S = t.regeneratorRuntime;
                if (S)
                    return void (E && (e.exports = S));
        ...
        181: [function(t, e, r) {
            ...
            var o = t("buffer")
              , a = o.Buffer;
            a.from && a.alloc && a.allocUnsafe && a.allocUnsafeSlow ? e.exports = o : (n(o, r),
            r.Buffer = i),
            n(a, i),
            ...
            (function(e) {
                ...
                !function(r) {
                    function n(t, e) {
                        ...
                        i.ENTITIES = i.strictEntities ? (0,
                        m.default)(r.XML_ENTITIES) : (0,
                        m.default)(r.ENTITIES),
                        i.attribList = [],
                        i.opt.xmlns && (i.ns = (0,
                        m.default)(G)),
                    ...
                    function c(t) {
                        x(t),
                        "" !== t.cdata && (_(t, "oncdata", t.cdata),
                        t.cdata = ""),
                        "" !== t.script && (_(t, "onscript", t.script),
                        t.script = "")
                    }
                    function l(t, e) {
                        return new f(t,e)
                    ...
                    function N(t, e) {
                        if (t.opt.xmlns) {
                            ...
                            r.local = n.local,
                            r.uri = r.ns[n.prefix] || "",
                            r.prefix && !r.uri && (k(t, "Unbound namespace prefix: " + (0,
                            s.default)(t.tagName)),
                            r.uri = n.prefix);
                            var i = t.tags[t.tags.length - 1] || t;
                            r.ns && i.ns !== r.ns && (0,
                            d.default)(r.ns).forEach(function(e) {
                                _(t, "onopennamespace", {
                                    prefix: e,
                                    uri: r.ns[e]
                                })
                            ...
                            for (var o = 0, a = t.attribList.length; o < a; o++) {
                                ...
                                f && "xmlns" !== f && !m && (k(t, "Unbound namespace prefix: " + (0,
                                s.default)(f)),
                                v.uri = f),
                        ...
                        t.tags.push(t.tag),
                        _(t, "onopentag", t.tag),
                        e || (t.noscript || "script" !== t.tagName.toLowerCase() ? t.state = V.TEXT : t.state = V.SCRIPT,
                        t.tag = null,
                        t.tagName = ""),
                        t.attribName = t.attribValue = "",
                        t.attribList.length = 0
                    ...
                    function L(t) {
                        ...
                        for (var i = t.tags.length; i-- > e; ) {
                            ...
                            t.opt.xmlns && o.ns !== c.ns && (0,
                            d.default)(o.ns).forEach(function(e) {
                                var r = o.ns[e];
                    ...
                    function I(t) {
                        ...
                        return t.ENTITIES[r] ? t.ENTITIES[r] : t.ENTITIES[n] ? t.ENTITIES[n] : (r = n,
                        "#" === r.charAt(0) && ("x" === r.charAt(1) ? (r = r.slice(2),
                        e = parseInt(r, 16),
                        i = e.toString(16)) : (r = r.slice(1),
                        e = parseInt(r, 10),
                        i = e.toString(10))),
                        r = r.replace(/^0+/, ""),
                        isNaN(e) || i.toLowerCase() !== r ? (k(t, "Invalid character entity"),
                        "&" + t.entity + ";") : (0,
                        o.default)(e))
                    }
                    function D(t, e) {
                        "<" === e ? (t.state = V.OPEN_WAKA,
                        t.startTagPosition = t.position) : h(e) || (k(t, "Non-whitespace before first tag."),
                        t.textNode = e,
                        t.state = V.TEXT)
                    }
                    function C(t, e) {
                    ...
                    function M(t) {
                        ...
                        if (this.error)
                            throw this.error;
                        if (e.closed)
                            return S(e, "Cannot write after close. Assign an onready handler.");
                        if (null === t)
                            return T(e);
                        "object" === (void 0 === t ? "undefined" : (0,
                        u.default)(t)) && (t = t.toString());
                        for (var r = 0, n = ""; ; ) {
                            if (n = C(t, r++),
                            e.c = n,
                            !n)
                            ...
                            case V.TEXT:
                                if (e.sawRoot && !e.closedRoot) {
                                    for (var o = r - 1; n && "<" !== n && "&" !== n; )
                                        (n = C(t, r++)) && e.trackPosition && (e.position++,
                                        "\n" === n ? (e.line++,
                                        e.column = 0) : e.column++);
                                    e.textNode += t.substring(o, r - 1)
                                }
                                "<" !== n || e.sawRoot && e.closedRoot && !e.strict ? (h(n) || e.sawRoot && !e.closedRoot || k(e, "Text data outside of root node."),
                                "&" === n ? e.state = V.TEXT_ENTITY : e.textNode += n) : (e.state = V.OPEN_WAKA,
                            ...
                            case V.SCRIPT_ENDING:
                                "/" === n ? e.state = V.CLOSE_TAG : (e.script += "<" + n,
                                e.state = V.SCRIPT);
                                continue;
                            case V.OPEN_WAKA:
                                if ("!" === n)
                                ...
                                continue;
                            case V.SGML_DECL:
                                (e.sgmlDecl + n).toUpperCase() === B ? (_(e, "onopencdata"),
                                e.state = V.CDATA,
                                e.sgmlDecl = "",
                                e.cdata = "") : e.sgmlDecl + n === "--" ? (e.state = V.COMMENT,
                                e.comment = "",
                                e.sgmlDecl = "") : (e.sgmlDecl + n).toUpperCase() === F ? (e.state = V.DOCTYPE,
                                (e.doctype || e.sawRoot) && k(e, "Inappropriately located doctype declaration"),
                                e.doctype = "",
                                e.sgmlDecl = "") : ">" === n ? (_(e, "onsgmldeclaration", e.sgmlDecl),
                                e.sgmlDecl = "",
                                e.state = V.TEXT) : v(n) ? (e.state = V.SGML_DECL_QUOTED,
                                e.sgmlDecl += n) : e.sgmlDecl += n;
                                continue;
                            case V.SGML_DECL_QUOTED:
                                n === e.q && (e.state = V.SGML_DECL,
                                e.q = ""),
                                e.sgmlDecl += n;
                                continue;
                            case V.DOCTYPE:
                                ">" === n ? (e.state = V.TEXT,
                                _(e, "ondoctype", e.doctype),
                                e.doctype = !0) : (e.doctype += n,
                                "[" === n ? e.state = V.DOCTYPE_DTD : v(n) && (e.state = V.DOCTYPE_QUOTED,
                                e.q = n));
                                continue;
                            ...
                            case V.DOCTYPE_DTD:
                                e.doctype += n,
                                "]" === n ? e.state = V.DOCTYPE : v(n) && (e.state = V.DOCTYPE_DTD_QUOTED,
                                e.q = n);
                                continue;
                            case V.DOCTYPE_DTD_QUOTED:
                                e.doctype += n,
                                n === e.q && (e.state = V.DOCTYPE_DTD,
                                e.q = "");
                                continue;
                            case V.COMMENT:
                            ...
                            case V.COMMENT_ENDING:
                                "-" === n ? (e.state = V.COMMENT_ENDED,
                                e.comment = E(e.opt, e.comment),
                                e.comment && _(e, "oncomment", e.comment),
                                e.comment = "") : (e.comment += "-" + n,
                                e.state = V.COMMENT);
                                continue;
                            case V.COMMENT_ENDED:
                                ">" !== n ? (k(e, "Malformed comment"),
                                e.comment += "--" + n,
                                e.state = V.COMMENT) : e.state = V.TEXT;
                                continue;
                            case V.CDATA:
                                "]" === n ? e.state = V.CDATA_ENDING : e.cdata += n;
                                continue;
                            case V.CDATA_ENDING:
                                "]" === n ? e.state = V.CDATA_ENDING_2 : (e.cdata += "]" + n,
                                e.state = V.CDATA);
                                continue;
                            case V.CDATA_ENDING_2:
                                ">" === n ? (e.cdata && _(e, "oncdata", e.cdata),
                                _(e, "onclosecdata"),
                                e.cdata = "",
                                e.state = V.TEXT) : "]" === n ? e.cdata += "]" : (e.cdata += "]]" + n,
                                e.state = V.CDATA);
                                continue;
                            case V.PROC_INST:
                            ...
                            case V.PROC_INST_ENDING:
                                ...
                                e.procInstName = e.procInstBody = "",
                                e.state = V.TEXT) : (e.procInstBody += "?" + n,
                                e.state = V.PROC_INST_BODY);
                                continue;
                            case V.OPEN_TAG:
                                b(H, n) ? e.tagName += n : (O(e),
                                ">" === n ? N(e) : "/" === n ? e.state = V.OPEN_TAG_SLASH : (h(n) || k(e, "Invalid character in tag name"),
                                e.state = V.ATTRIB));
                                continue;
                            case V.OPEN_TAG_SLASH:
                                ">" === n ? (N(e, !0),
                                L(e)) : (k(e, "Forward-slash in opening tag not followed by >"),
                                e.state = V.ATTRIB);
                                continue;
                            case V.ATTRIB:
                                if (h(n))
                                    continue;
                                ">" === n ? N(e) : "/" === n ? e.state = V.OPEN_TAG_SLASH : b(z, n) ? (e.attribName = n,
                                e.attribValue = "",
                                e.state = V.ATTRIB_NAME) : k(e, "Invalid attribute name");
                                continue;
                            case V.ATTRIB_NAME:
                                "=" === n ? e.state = V.ATTRIB_VALUE : ">" === n ? (k(e, "Attribute without value"),
                                e.attribValue = e.attribName,
                                A(e),
                                N(e)) : h(n) ? e.state = V.ATTRIB_NAME_SAW_WHITE : b(H, n) ? e.attribName += n : k(e, "Invalid attribute name");
                                continue;
                            ...
                            case V.ATTRIB_VALUE:
                                if (h(n))
                                    continue;
                                v(n) ? (e.q = n,
                                e.state = V.ATTRIB_VALUE_QUOTED) : (k(e, "Unquoted attribute value"),
                            ...
                            case V.ATTRIB_VALUE_CLOSED:
                                h(n) ? e.state = V.ATTRIB : ">" === n ? N(e) : "/" === n ? e.state = V.OPEN_TAG_SLASH : b(z, n) ? (k(e, "No whitespace between attributes"),
                                e.attribName = n,
                                e.attribValue = "",
                                e.state = V.ATTRIB_NAME) : k(e, "Invalid attribute name");
                                continue;
                            ...
                            case V.CLOSE_TAG:
                                if (e.tagName)
                                    ">" === n ? L(e) : b(H, n) ? e.tagName += n : e.script ? (e.script += "</" + e.tagName,
                                    e.tagName = "",
                                    e.state = V.SCRIPT) : (h(n) || k(e, "Invalid tagname in closing tag"),
                                    e.state = V.CLOSE_TAG_SAW_WHITE);
                                else {
                                    if (h(n))
                                        continue;
                                    g(z, n) ? e.script ? (e.script += "</" + n,
                                    e.state = V.SCRIPT) : k(e, "Invalid tagname in closing tag.") : e.tagName = n
                                }
                                continue;
                            ...
                            case V.ATTRIB_VALUE_ENTITY_U:
                                ...
                                ";" === n ? (e[c] += I(e),
                                e.entity = "",
                                e.state = s) : b(e.entity.length ? Y : W, n) ? e.entity += n : (k(e, "Invalid character in entity name"),
                                e[c] += "&" + e.entity + n,
                                e.entity = "",
                                e.state = s);
                                continue;
                    ...
                    (0,
                    d.default)(r.ENTITIES).forEach(function(t) {
                        var e = r.ENTITIES[t]
                        ...
                        var t = String.fromCharCode
                          ...
                          , r = function() {
                            ...
                            for (var s = ""; ++o < a; ) {
                                ...
                                c <= 65535 ? i.push(c) : (c -= 65536,
                                r = 55296 + (c >> 10),
                                n = c % 1024 + 56320,
                                i.push(r, n)),
                                (o + 1 === a || i.length > 16384) && (s += t.apply(null, i),
                                i.length = 0)
                            }
                            return s
                        };
        ...
        183: [function(t, e, r) {
            ...
            n.prototype.pipe = function(t, e) {
                ...
                u.on("data", r),
                t.on("drain", n),
                t._isStdio || e && !1 === e.end || (u.on("end", o),
                u.on("close", a));
                var l = !1;
                return u.on("error", s),
                t.on("error", s),
            ...
            (function(r, n, i) {
                ...
                var s = t("babel-runtime/core-js/object/keys")
                  ...
                  , v = e.exports = function(t) {
                    ...
                    (0,
                    c.default)(t.headers).forEach(function(r) {
                        e.setHeader(r, t.headers[r])
                    });
                    var r, n = !0;
                    if ("disable-fetch" === t.mode || "timeout"in t)
                        n = !1,
                        r = !0;
                ...
                v.prototype._onFinish = function() {
                    ...
                    if (!t._destroyed) {
                        ...
                        var s = [];
                        if ((0,
                        c.default)(o).forEach(function(t) {
                            var e = o[t].name
                              , r = o[t].value;
                        ...
                        "fetch" === t._mode)
                            ...
                            "timeout"in e && (l.timeout = e.timeout,
                ...
                v.prototype._onXHRProgress = function() {
                    var t = this;
                    a(t._xhr) && !t._destroyed && (t._response || t._connect(),
                    t._response._onXHRProgress())
                }
                ,
                v.prototype._connect = function() {
                    var t = this;
                    t._destroyed || (t._response = new h(t._xhr,t._fetchResponse,t._mode),
                    ...
                    "fetch" === n) {
                        ...
                        if (t.getAllResponseHeaders().split(/\r?\n/).forEach(function(t) {
                            ...
                            if (e) {
                                ...
                                "set-cookie" === r ? (void 0 === a.headers[r] && (a.headers[r] = []),
                                a.headers[r].push(e[2])) : void 0 !== a.headers[r] ? a.headers[r] += ", " + e[2] : a.headers[r] = e[2],
                ...
                u.prototype._onXHRProgress = function() {
                    ...
                    case "ms-stream":
                        ...
                        u.onprogress = function() {
                            u.result.byteLength > t._pos && (t.push(new i(new Uint8Array(u.result.slice(t._pos)))),
        ...
        191: [function(t, e, r) {
            ...
            function i(t, e, r) {
                if (t && u.isObject(t) && t instanceof n)
                    return t;
                var i = new n;
            ...
            n.prototype.parse = function(t, e, r) {
                ...
                !r && 1 === t.split("#").length) {
                    ...
                    if (p)
                        ...
                        this.pathname = p[1],
                        p[2] ? (this.search = p[2],
                        this.query = e ? E.parse(this.search.substr(1)) : this.search.substr(1)) : e && (this.search = "",
                        this.query = {}),
                        this
                }
                var d = l.exec(s);
                ...
                if (!_[d] && (S || d && !x[d])) {
                    ...
                    if (!N)
                        for (var L = this.hostname.split(/\./), k = 0, I = L.length; k < I; k++) {
                            var D = L[k];
                            if (D && !D.match(b)) {
                                for (var C = "", M = 0, P = D.length; M < P; M++)
                                    D.charCodeAt(M) > 127 ? C += "x" : C += D[M];
                                if (!C.match(b)) {
                                    var R = L.slice(0, k)
                                      , U = L.slice(k + 1)
                                      , B = D.match(g);
                ...
                s = s.slice(0, z));
                var H = s.indexOf("?");
                if (-1 !== H ? (this.search = s.substr(H),
                this.query = s.substr(H + 1),
                e && (this.query = E.parse(this.query)),
                s = s.slice(0, H)) : e && (this.search = "",
                this.query = {}),
                s && (this.pathname = s),
            ...
            n.prototype.resolveObject = function(t) {
                ...
                if (!E.length)
                    ...
                    r.href = r.format(),
                    r;
                for (var k = E.slice(-1)[0], O = (r.host || t.host || E.length > 1) && ("." === k || ".." === k) || "" === k, j = 0, A = E.length; A >= 0; A--)
                    k = E[A],
                    "." === k ? E.splice(A, 1) : ".." === k ? (E.splice(A, 1),
                    j++) : j && (E.splice(A, 1),
                    j--);
                if (!g && !w)
                    for (; j--; j)
        ...
        196: [function(t, e, r) {
            (function(e, n) {
                ...
                function c(t, e, n) {
                    ...
                    if (x(e) && (y = " " + RegExp.prototype.toString.call(e)),
                    S(e) && (y = " " + Date.prototype.toUTCString.call(e)),
                    T(e) && (y = " " + l(e)),
                    0 === a.length && (!b || 0 == e.length))
                        return w[0] + y + w[1];
                    if (n < 0)
                ...
                function p(t, e, r, n, i) {
                    for (var o = [], a = 0, s = e.length; a < s; ++a)
                        L(e, String(a)) ? o.push(f(t, e, r, n, String(a), !0)) : o.push("");
                ...
                function f(t, e, r, n, i, o) {
                    ...
                    L(n, i) || (a = "[" + i + "]"),
                    s || (t.seen.indexOf(u.value) < 0 ? (s = v(r) ? c(t, u.value, null) : c(t, u.value, r - 1),
                    s.indexOf("\n") > -1 && (s = o ? s.split("\n").map(function(t) {
                        return "  " + t
                    }).join("\n").substr(2) : "\n" + s.split("\n").map(function(t) {
                        return "   " + t
            ...
            (function() {
                ...
                r.Builder = function() {
                    ...
                    return t.prototype.buildObject = function(t) {
                        ...
                        1 === (0,
                        s.default)(t).length && this.options.rootName === n[.2].rootName ? (f = (0,
                        s.default)(t)[0],
                        t = t[f]) : f = this.options.rootName,
                        l = function(t) {
                            return function(e, n) {
                                var s, p, f, d, h, m;
                                ...
                                o.default)(n)))
                                    ...
                                    for (h in n)
                                        if (u.call(n, h))
                                            if (p = n[h],
                                            h === r) {
                                                if ("object" === (void 0 === p ? "undefined" : (0,
                                                o.default)(p)))
                                                    for (s in p)
                                                        m = p[s],
                                                        e = e.att(s, m)
                                                ...
                                                for (d in p)
                                                    u.call(p, d) && (f = p[d],
                                                    e = "string" == typeof f ? t.options.cdata && a(f) ? e.ele(h).raw(c(f)).up() : e.ele(h, f).up() : l(e.ele(h), f).up());
                                            else
                                                "object" === (void 0 === p ? "undefined" : (0,
                                                o.default)(p)) ? e = l(e.ele(h), p).up() : "string" == typeof p && t.options.cdata && a(p) ? e = e.ele(h).raw(c(p)).up() : (null == p && (p = ""),
            ...
            (function() {
                ...
                r.Parser = function(t) {
                    ...
                    i.prototype.assignOrPush = function(t, e, r) {
                        ...
                        t[e].push(r)) : this.options.explicitArray ? t[e] = [r] : t[e] = r
                    }
                    ,
                    i.prototype.reset = function() {
                        ...
                        this.saxParser.onerror = function(t) {
                            return function(e) {
                                if (t.saxParser.resume(),
                                !t.saxParser.errThrown)
                                    return t.saxParser.errThrown = !0,
                                    t.emit("error", e)
                            }
                        }(this),
                        ...
                        this.saxParser.onopentag = function(r) {
                            return function(i) {
                                ...
                                if (s = {},
                                s[e] = "",
                                !r.options.ignoreAttrs) {
                                    l = i.attributes;
                                    for (o in l)
                                        m.call(l, o) && (t in s || r.options.mergeAttrs || (s[t] = {}),
                                        a = r.options.attrValueProcessors ? c(r.options.attrValueProcessors, i.attributes[o], o) : i.attributes[o],
                                        u = r.options.attrNameProcessors ? c(r.options.attrNameProcessors, o) : o,
                        ...
                        this.saxParser.onclosetag = function(t) {
                            return function() {
                                ...
                                if (d = n.pop(),
                                f = d["#name"],
                                t.options.explicitChildren && t.options.preserveChildrenOrder || delete d["#name"],
                                !0 === d.cdata && (r = d.cdata,
                                delete d.cdata),
                                y = n[n.length - 1],
                                d[e].match(/^\s*$/) && !r ? (i = d[e],
                                delete d[e]) : (t.options.trim && (d[e] = d[e].trim()),
                                t.options.normalize && (d[e] = d[e].replace(/\s{2,}/g, " ").trim()),
                                d[e] = t.options.valueProcessors ? c(t.options.valueProcessors, d[e], f) : d[e],
                                1 === (0,
                                s.default)(d).length && e in d && !t.EXPLICIT_CHARKEY && (d = d[e])),
                                a(d) && (d = "" !== t.options.emptyTag ? t.options.emptyTag : i),
                                null != t.options.validator && (b = "/" + function() {
                                    var t, e, r;
                                    for (r = [],
                                    t = 0,
                                    e = n.length; t < e; t++)
                                ...
                                t.options.explicitChildren && !t.options.mergeAttrs && "object" === (void 0 === d ? "undefined" : (0,
                                u.default)(d)))
                                    if (t.options.preserveChildrenOrder) {
                                        ...
                                        p = {},
                                        t.options.attrkey in d && (p[t.options.attrkey] = d[t.options.attrkey],
                                        delete d[t.options.attrkey]),
                                        !t.options.charsAsChildren && t.options.charkey in d && (p[t.options.charkey] = d[t.options.charkey],
                                        delete d[t.options.charkey]),
                                        (0,
                                        o.default)(d).length > 0 && (p[t.options.childkey] = d),
                                        d = p;
                                return n.length > 0 ? t.assignOrPush(y, f, d) : (t.options.explicitRoot && (v = d,
                                d = {},
                                d[f] = v),
                                t.resultObject = d,
                                t.saxParser.ended = !0,
                    ...
                    i.prototype.parseString = function(t, r) {
                        ...
                        try {
                            return t = t.toString(),
                            "" === t.trim() ? (this.emit("end", null),
                            !0) : (t = e.stripBOM(t),
                            this.options.async ? (this.remaining = t,
                            f(this.processAsync),
                            this.saxParser) : this.saxParser.write(t).close())
                        } catch (t) {
                            if (n = t,
                ...
                r.parseString = function(t, e, n) {
                    var i, o, a;
                    return null != n ? ("function" == typeof n && (i = n),
                    "object" === (void 0 === e ? "undefined" : (0,
                    u.default)(e)) && (o = e)) : ("function" == typeof e && (i = e),
                    o = {}),
                    a = new r.Parser(o),
                    a.parseString(t, i)
                }
        ...
        203: [function(t, e, r) {
            ...
            (function() {
                ...
                a = function(t) {
                    var e;
                    return !!t && ("function" === (e = void 0 === t ? "undefined" : (0,
                    s.default)(t)) || "object" === e)
                }
                ,
                r = function(t) {
                ...
                c = function(t) {
                    var e, r;
                    return a(t) && (r = (0,
                    o.default)(t)) && (e = r.constructor) && "function" == typeof e && e instanceof e && Function.prototype.toString.call(e) === Function.prototype.toString.call(Object)
                }
                ,
                e.exports.assign = t,
        ...
        205: [function(t, e, r) {
            ...
            (function() {
                ...
                e.exports = function(t) {
                    function e(t, r) {
                        if (e.__super__.constructor.call(this, t),
                        null == r)
            ...
            (function() {
                ...
                e.exports = function() {
                    function t(t, e, r) {
                        var n;
                        t || (t = {}),
                        t.writer ? g(t.writer) && (n = t.writer,
                        t.writer = new h(n)) : t.writer = new h(t),
                        this.options = t,
                    ...
                    t.prototype.openNode = function(t) {
                        if (!t.isOpen)
                            return !this.root && 0 === this.currentLevel && t instanceof p && (this.root = t),
                ...
                e.exports = function() {
                            ...
                            for (s in t)
                                if (h.call(t, s))
                                    ...
                                    !this.options.ignoreDecorators && this.stringify.convertAttKey && 0 === s.indexOf(this.stringify.convertAttKey))
                                        ...
                                        f(v) ? (c = this.element(s),
                                        c.element(v)) : c = this.element(s, v)
                        } else
                            c = !this.options.ignoreDecorators && this.stringify.convertTextKey && 0 === t.indexOf(this.stringify.convertTextKey) ? this.text(r) : !this.options.ignoreDecorators && this.stringify.convertCDataKey && 0 === t.indexOf(this.stringify.convertCDataKey) ? this.cdata(r) : !this.options.ignoreDecorators && this.stringify.convertCommentKey && 0 === t.indexOf(this.stringify.convertCommentKey) ? this.comment(r) : !this.options.ignoreDecorators && this.stringify.convertRawKey && 0 === t.indexOf(this.stringify.convertRawKey) ? this.raw(r) : !this.options.ignoreDecorators && this.stringify.convertPIKey && 0 === t.indexOf(this.stringify.convertPIKey) ? this.instruction(t.substr(this.stringify.convertPIKey.length), r) : this.node(t, e, r);
                        if (null == c)
                    ...
                    e.prototype.doctype = function(t, e) {
                        ...
                        l = f.length; c < l; a = ++c)
                            if (r = f[a],
                            r.isRoot)
                                return n.children.splice(a, 0, i),
                                i;
            ...
            (function() {
                ...
                e.exports = function(t) {
                    ...
                    e.prototype.dtdEntity = function(t, e) {
                        ...
                        t.pe && (r += " %"),
                        r += " " + t.name,
                        t.value ? r += ' "' + t.value + '"' : (t.pubID && t.sysID ? r += ' PUBLIC "' + t.pubID + '" "' + t.sysID + '"' : t.sysID && (r += ' SYSTEM "' + t.sysID + '"'),
            ...
            (function() {
                ...
                e.exports = function() {
                    function e(e) {
                        ...
                        this.pretty ? (this.indent = null != (i = e.indent) ? i : "  ",
                        this.newline = null != (o = e.newline) ? o : "\n",
                        this.offset = null != (a = e.offset) ? a : 0,
                        this.dontprettytextnodes = null != (s = e.dontprettytextnodes) ? s : 0) : (this.indent = "",
                        this.newline = "",
                        this.offset = 0,
                    ...
                    e.prototype.space = function(t) {
                        var e;
                        return this.pretty ? (e = (t || 0) + this.offset + 1,
        ...
        229: [function(t, e, r) {
            (function(e, n) {
                ...
                var s, c = t("babel-runtime/core-js/json/stringify"), u = i(c), l = t("babel-runtime/helpers/typeof"), p = i(l), f = t("util"), d = t("url"), h = t("http"), m = t("https"), v = t("debug")("urllib"), y = t("humanize-ms"), b = 0, g = Math.pow(2, 31) - 10, w = /^https?:\/\//i;
                r.TIMEOUT = y("5s"),
                ...
                r.request = function(e, n, i) {
                    ...
                    n = null),
                    "function" == typeof i ? r.requestWithCallback(e, n, i) : (s || (s = t("any-promise")),
                    new s(function(t, i) {
                ...
                r.requestWithCallback = function(i, a, s) {
                    ...
                    function x(t, n, o) {
                        if (l(),
                        !s)
                            return console.warn("[urllib:warn] [%s] [%s] [worker:%s] %s %s callback twice!!!", Date(), A, e.pid, U.method, i),
                            void (t && console.warn("[urllib:warn] [%s] [%s] [worker:%s] %s: %s\nstack: %s", Date(), A, e.pid, t.name, t.message, t.stack));
                        var c = s;
                        s = null;
                        var p = {};
                        if (o && (tt = o.statusCode,
                        p = o.headers),
                        401 === tt && p["www-authenticate"] && (!a.headers || !a.headers.Authorization) && a.digestAuth) {
                            var f = p["www-authenticate"];
                            if (f.indexOf("Digest ") >= 0)
                                return v("Request#%d %s: got digest auth header WWW-Authenticate: %s", A, i, f),
                                a.headers = a.headers || {},
                        ...
                        if (t) {
                            var m = "";
                            P && "function" == typeof P.getCurrentStatus && (m = ", agent status: " + (0,
                            u.default)(P.getCurrentStatus())),
                    ...
                    function E(t) {
                        ...
                        if (a.followRedirect && statuses.redirect[t.statusCode]) {
                            ...
                            if (n) {
                                ...
                                e = new Error("Got statusCode " + t.statusCode + " but cannot resolve next location from headers"),
                    ...
                    function T(t) {
                        if (it && (it.waiting = Date.now() - I),
                        v("Request#%d %s `req response` event emit: status %d, headers: %j", A, i, t.statusCode, t.headers),
                        a.streaming) {
                            var e = E(t);
                            return e.redirect ? void t.resume() : e.error ? (t.resume(),
                            x(e.error, null, t)) : x(null, null, t)
                        }
                        ...
                        ot) {
                            ...
                            return e.redirect ? void t.resume() : e.error ? (t.resume(),
                            ot.end(),
                            x(e.error, null, t)) : (!1 === a.consumeWriteStream ? t.on("end", x.bind(null, null, null, t)) : isNode010 || isNode012 ? first([[ot, "close"], [t, "aborted"]], function(e, r, n) {
                        ...
                        t.on("end", function() {
                            var e = n.concat(r, Z);
                            if (v("Request#%d %s: `res end` event emit, total size %d, _dumped: %s", A, i, Z, t._dumped),
                            $)
                                return x($, e, t);
                            var o = E(t);
                            if (o.error)
                                return x(o.error, e, t);
                    ...
                    function O() {
                        ...
                        ct.socket || ($.noSocket = !0,
                        x($)),
                        ct.abort()
                    }
                    if (!i || "string" != typeof i && "object" !== (void 0 === i ? "undefined" : (0,
                    p.default)(i))) {
                        var j = f.format("expect request url to be a string or a http request options, but got %j", i);
                        throw new Error(j)
                    }
                    2 === arguments.length && "function" == typeof a && (s = a,
                    a = null),
                    a = a || {},
                    b >= g && (b = 0);
                    var A = ++b;
                    ...
                    var L, I = Date.now();
                    "string" == typeof i ? (w.test(i) || (i = "http://" + i),
                    L = d.parse(i)) : L = i;
                    var D = (a.type || a.method || L.method || "GET").toUpperCase()
                      ...
                      , P = o(a.agent, r.agent)
                      , R = a.fixJSONCtlChars;
                    "https:" === L.protocol && (M = m,
                    P = o(a.httpsAgent, r.httpsAgent),
                    L.port || (C = 443));
                    var U = {
                    ...
                    if (!a.content && G && "string" != typeof G && !n.isBuffer(G))
                        if (z)
                            G = a.nestedQuerystring ? qs.stringify(G) : querystring.stringify(G);
                        else {
                            var H = U.headers["Content-Type"] || U.headers["content-type"];
                            H || (H = "json" === a.contentType ? "application/json" : "application/x-www-form-urlencoded",
                            U.headers["Content-Type"] = H),
                            G = "application/json" === parseContentType(H).type ? (0,
                            u.default)(G) : a.nestedQuerystring ? qs.stringify(G) : querystring.stringify(G)
                        }
                    z && G && (U.path += (L.query ? "&" : "?") + G,
                    G = null);
                    var W = 0;
                    if (G) {
                        var Y = G.length;
                    ...
                    var at, st;
                    Array.isArray(a.timeout) ? (at = y(a.timeout[0]),
                    st = y(a.timeout[1])) : at = st = y(a.timeout),
                    ...
                    return "undefined" == typeof window ? function() {
                        ...
                        V = setTimeout(function() {
                            ...
                            ct.socket || (e = "SocketAssignTimeoutError",
                    ...
                    ct.once("socket", function(t) {
                        ...
                        var e = t.readyState;
                        if ("opening" === e)
                            return t.once("lookup", function(t, e, r) {
