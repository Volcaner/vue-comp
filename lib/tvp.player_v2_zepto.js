...
!function(a) {
    ...
    tvp = {},
    tvp.lastModify = "2017-12-27 16:57:50",
    tvp.ts = tvp.lastModify.replace(/\D/g, ""),
    tvp.ver = "$V2.0Build9496$",
    tvp.dataset = {
        openLazy: !0
    },
    tvp.name = "\u817e\u8baf\u89c6\u9891\u7edf\u4e00\u64ad\u653e\u5668",
        ...
        return "film.qq.com" == document.location.host && (i = !0),
        {
            getOcx: function(b) {
                ...
                if (tvp.$.browser.ie)
                    try {
                        ...
                        "undefined" != typeof c.getVersion ? (d = c.GetVersionByClsid(f.config.OCX_CLSID),
                    ...
                    if (tvp.$.isUndefined(l.namedItem) || (e = "plugs.namedItem",
                    k = l.namedItem("\u817e\u8baf\u89c6\u9891")),
                    !k) {
                        e = "no plugs.namedItem:tencentvideo";
                        for (var m = 0, n = l.length; n > m; m++)
                            if (l[m] && "\u817e\u8baf\u89c6\u9891" == l[m].name || "npQQLive.dll" == l[m].filename) {
                                k = l[m];
                                break
                            }
                    }
                    if (k)
                        if (tvp.$.isUndefined(k.version)) {
                            e = "plug.description:" + k.description;
                            var o, p = k.description;
                            o = p.match(/version:((\d+\.){3}(\d+)?)/),
                            o && (d = o[1])
                        } else
                            e = "plug.version:" + k.version,
                            d = k.version;
                    else
            ...
            getFlash: function() {
                ...
                if (tvp.$.browser.ie)
                    ...
                    tvp.$.isUndefined(j.plugins) || "object" != typeof j.plugins[f] || (a = "no IE begin",
                    c = j.plugins[f].description,
    ...
    function(a, b) {
        ...
        a.h5Helper = {
            ...
            loadVideoUrlByVid_base: function(e, f) {
                ...
                e.retryDefer && b.isFunction(e.retryDefer.reject) && (t = !0,
                q = e.retryDefer,
                u = k.retryCgi.getinfo,
                z = k.retryCgi.getkey),
                e.loadingAdCgi && (u = e.loadingAdCgi,
                e.noAuth = !0),
                e.defer && (q = e.defer),
                y = i({
                    itype: 1,
                ...
                var A = function(d) {
                  ...
                  , B = function(f) {
                    ...
                    b.ajax({
                        ...
                        t ? q.reject(500, 2) : (e.retryDefer = q,
    ...
    f.param = {
        ...
        getParamBool: function(a) {
            return void 0 === a ? !1 : "string" == typeof a ? (a = a.toLowerCase(),
            "true" == a || "1" == a) : !!a
        },
    ...
    f.version = function() {
        function a(a) {
            if (f.version.checkVerFormatValid(a))
                return a;
            if (/\d+/i.test(a)) {
        ...
        return _version = {},
        {
            ...
            check: function(b) {
                if (b = b || f.version.getSupportMinVersion(),
                !f.version.checkVerFormatValid(b))
                    return !1;
            ...
            hasOldVersion: function() {
                ...
                return a ? (c = f.version.compare(a, f.config.OLD_MIN_VER) > 0 ? 1 : 0,
                !!c) : !1
            },
            hasQQLivePlayer: function() {
                ...
                return a ? (b = f.version.compare(a, "0.0.0.0") > 0 ? 1 : 0,
                !!b) : !1
            },
    ...
    f.installer = {
        ...
        isMMInstalled: function() {
            if (tvp.$.browser.ie)
                try {
                    ...
                    if ("undefined" != typeof a.GetVersionByClsid)
                        return !0;
                    try {
                        a.Destroy(),
                        a = null,
                ...
                try {
                    if (c.CreateAX("MMInstall.dll"),
                    "undefined" != typeof c.GetVersionByClsid)
                        return !0;
                    try {
                        c.Destroy(),
                        c = null,
        ...
        getActiveXObj: function(a, b) {
            ...
            if (b && tvp.$.browser.isNotIESupport()) {
                if (c = document.embeds.FF_MM_Install,
                !c) {
        ...
        openClient: function(a, b) {
            if (a && f.version.hasQQLivePlayer()) {
                ...
                if (!b) {
                    ...
                    if (/^\d+$/i.test(d))
                        c += "projectid=" + d;
                    else if (d.toLowerCase().indexOf("qqlive://sso/") >= 0)
                        c = d;
                    else {
                        if (!/^[a-z0-9]{15}$/i.test(d))
                            return;
                        c += "vbarid=" + d
                    }
                }
    ...
    f.event = {
        ...
        reportTCSSHot: function(a, b) {
            ...
            }) : (f.event.rptImg = new Image,
            f.event.rptImg.src = "http://pinghot.qq.com/pingd?dm=v.qq.com.hot&url=/virtual/ocx.html&tt=" + escape(document.title) + "&hottag=OCX.SETUP." + a + "&hotx=9999&hoty=9999&rand=" + Math.round(1e5 * Math.random())),
            tvp.$.cookie.set("lv_ocx_rpt", d | b, document.location.hostname || document.location.hostname))
        }
    };
    var f = f || {};
    f.DEFINE = {
    ...
    function(a, b) {
        ...
        function e(c, d) {
            ...
            if ("function" == typeof a[c])
                ...
                l.begin(),
                d(1),
                b.getScript(k, function() {
                    var e = b.now() - m;
                    if ("function" != typeof a[c])
                        throw l.reportErr(11),
                        d(2, 11, e),
                        new Error(i[1]);
                    d(2, 0, e),
                    l.reportSuc(),
            ...
            create: function(e) {
                ...
                var g = function() {
                    j(f.config, f).done(function(d, g) {
                        ...
                        for (var i in f.instance)
                            "instance" != i && ("on" == i.substr(0, 2) && b.isFunction(f[i]) && f[i] != a.$.noop || (f[i] = f.instance[i]));
                        ...
                        f.config.type == a.PLAYER_DEFINE.LIVE && (f.play = function(c) {
                            ...
                            c = f.config.video) : c instanceof a.VideoInfo && b.when(j.checkLivePlayer(c)).then(function() {
