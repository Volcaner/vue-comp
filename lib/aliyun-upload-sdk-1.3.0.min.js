    ...
    var i = function() {
      ...
      , o = function() {
        ...
        return i(t, null, [{
            key: "detectIEVersion",
            value: function() {
                for (var t = 4, e = document.createElement("div"), n = e.getElementsByTagName("i"); e.innerHTML = "\x3c!--[if gt IE " + t + "]><i></i><![endif]--\x3e",
                n[0]; )
                    t++;
                return t > 4 && t
            }
            ...
            value: function(t, e) {
                for (var n in e)
                    Object.prototype.hasOwnProperty.call(e, n) && e[n] && (t[n] = e[n])
            }
        }, {
            key: "isArray",
            value: function(t) {
            ...
            value: function(t) {
                ...
                /.mp4|.flv|.m3u8|.avi|.rm|.rmvb|.mpeg|.mpg|.mov|.wmv|.3gp|.asf|.dat|.dv|.f4v|.gif|.m2t|.m4v|.mj2|.mjpeg|.mpe|.mts|.ogg|.qt|.swf|.ts|.vob|.wmv|.webm/.test(t) ? "video" : /.mp3|.wav|.ape|.cda|.au|.midi|.mac|.aac|.ac3|.acm|.amr|.caf|.flac|.m4a|.ra|.wma/.test(t) ? "audio" : /.bmp|.jpg|.jpeg|.png/.test(t) ? "img" : "other"
            }
        }, {
            key: "isImage",
            value: function(t) {
      ...
      , o = function() {
        ...
        return i(t, null, [{
            ...
            value: function(t, e) {
                ...
                t)
                    for (n = 0; n < t; n++)
                        i[n] = r[0 | Math.random() * e];
                else {
                    var o;
                    for (i[8] = i[13] = i[18] = i[23] = "-",
                    i[14] = "4",
                    n = 0; n < 36; n++)
                        i[n] || (o = 0 | 16 * Math.random(),
                        i[n] = r[19 == n ? 3 & o | 8 : o])
                }
                return i.join("")
            }
...
, function(t, e, n) {
    "use strict";
    var r, i, o = ("function" == typeof Symbol && Symbol.iterator,
    n(6)), a = function(t) {
      ...
      , A = function() {
        ...
        return o(t, [{
            ...
            value: function(t, e, n, r) {
                ...
                !(n && !r || !n && r) && (!(t && !e || !t && e) && (this._ossCreditor.accessKeyId = t,
                this._ossCreditor.accessKeySecret = e,
            ...
            value: function(t, e, n, r, i) {
                ...
                0); o < this._uploadList.length; o++)
                    if (this._uploadList[o].file == t)
                        return !1;
                var s = new Object;
                return s.file = t,
                s._endpoint = e,
                ...
                s.isImage = v.default.isImage(t.name),
            ...
            key: "deleteFile",
            value: function(t) {
                return !!this.cancelFile(t) && (this._uploadList.splice(t, 1),
                !0)
            }
        }, {
            key: "cleanList",
            ...
            value: function(t) {
                this.options;
                if (t < 0 || t >= this._uploadList.length)
                    return !1;
                var e = this._uploadList[t];
                if (t == this._curIndex && e.state == a.UPLOADSTATE.UPLOADING) {
                    e.state = a.UPLOADSTATE.CANCELED;
                    var n = this._getCheckoutpoint(e);
                    n && n.checkpoint && (n = n.checkpoint),
                    n && this._ossUpload.abort(e),
                    this._removeCheckoutpoint(e),
                    this.nextUpload()
                } else
                    e.state != a.UPLOADSTATE.SUCCESS && (e.state = a.UPLOADSTATE.CANCELED);
                return this._reportLog("20008", e),
                !0
            }
        }, {
            key: "resumeFile",
            value: function(t) {
                ...
                if (t < 0 || t >= this._uploadList.length)
                    return !1;
                var e = this._uploadList[t];
                return e.state == a.UPLOADSTATE.CANCELED && (e.state = a.UPLOADSTATE.INIT,
                !0)
            }
        }, {
            key: "listFiles",
            ...
            value: function() {
                ...
                if (this._state == a.VODSTATE.START) {
                    if (this._curIndex = this._findUploadIndex(),
                    -1 == this._curIndex)
                        return void (this._state = a.VODSTATE.END);
                    var t = this._uploadList[this._curIndex];
                    this._ossUpload = null,
            ...
            key: "clear",
            value: function(t) {
                for (var e = this.options, n = 0, r = 0; r < this._uploadList.length; r++)
                    e.uploadList[r].state == a.UPLOADSTATE.SUCCESS && n++,
                    this._uploadList[r].state == t && (e.uploadList.splice(r, 1),
                    r--);
                e.onClear && e.onClear(e.uploadList.length, n)
            }
        }, {
            key: "stopUpload",
            value: function() {
            ...
            value: function(t) {
                ...
                if (!t)
                    return !1;
                var n = JSON.parse(l.default.decode(t));
                return !!(n.AccessKeyId && n.AccessKeySecret && n.SecurityToken && n.Expiration) && e.resumeUploadWithToken(n.AccessKeyId, n.AccessKeySecret, n.SecurityToken, n.Expiration)
            }
        }, {
            ...
            value: function(t, e, n, r) {
                ...
                i && (this.init(t, e, n, r),
                this._ossUpload = null,
                this._uploadCore(i, uploadInfo.retry),
                uploadInfo.retry = !1),
                !0
            }
        }, {
            ...
            value: function(t, e, n) {
                ...
                if (this._uploadList.length > this._curIndex) {
                    ...
                    r.object ? this._refreshSTSTokenUpload(r, t, e, n) : this.setSTSToken(r, t, e, n)
                }
            }
        }, {
            key: "setSTSToken",
            value: function(t, e, n, r) {
                if (!e || !n || !r)
                    return console.log("accessKeyId、ccessKeySecret、securityToken should not be empty."),
                    !1;
                this._uploadWay = "sts";
                var i = t.videoInfo
                  , o = {
                ...
                var a = this
                  , s = "getUploadAuth";
                t.isImage && (s = "getImageUploadAuth"),
                T.default[s](o, function(e) {
                    a.setUploadAuthAndAddress(t, e.UploadAuth, e.UploadAddress)
                }, function(e) {
                    a._error(t, {
                        name: e.Code,
                        code: e.Code,
            ...
            value: function(t, e, n) {
                ...
                if (!(r.AccessKeyId && r.AccessKeySecret && r.SecurityToken && r.Expiration))
                    return console.error("uploadauth is invalid"),
                    !1;
                var i = {};
                if (n) {
                    if (i = JSON.parse(l.default.decode(n)),
                    !i.Endpoint || !i.Bucket || !i.FileName)
                        return console.error("uploadAddress is invalid"),
                        !1
                } else
                ...
                this._uploadWay = "vod";
                var o = t;
                this.init(r.AccessKeyId, r.AccessKeySecret, r.SecurityToken, r.Expiration),
                o.endpoint = o._endpoint ? o._endpoint : i.Endpoint,
                o.bucket = o._bucket ? o._bucket : i.Bucket,
                o.object = o._object ? o._object : i.FileName,
                this._ossUpload = null,
                this._uploadCore(o, t.retry),
                t.retry = !1
            }
        }, {
            ...
            value: function(t, e, n, r) {
                ...
                var i = {
                  ...
                  , o = this
                  , a = "refreshUploadAuth";
                t.isImage && (a = "getImageUploadAuth"),
                T.default[a](i, function(e) {
                    o.setUploadAuthAndAddress(t, e.UploadAuth, UploadAddress)
                }, function(e) {
                    o._error(t, {
                        name: e.Code,
                        code: e.Code,
            ...
            value: function(t) {
                ...
                if (t.state = a.UPLOADSTATE.UPLOADING,
                !this._ossUpload) {
                    t.endpoint = t.endpoint || "http://oss-cn-hangzhou.aliyuncs.com";
                    var e = this;
                    this._ossUpload = new c.default({
                        ...
                        oncomplete: function(t, n) {
                            e._complete.call(e, t, n)
                        },
                        onprogress: function(t, n, r) {
                            e._progress.call(e, t, n, r)
                        }
                    })
                }
                var n = v.default.getFileType(t.file.name)
                  , r = this._getCheckoutpoint(t)
                  , i = ""
                  , o = r.state;
                r && r.checkpoint && (i = r.object,
                r = r.checkpoint),
                r && o != a.UPLOADSTATE.UPLOADING && (r.file = t.file,
                t.checkpoint = r,
                i && (t.object = i),
                r.uploadId);
                var s = this._adjustPartSize(t);
                this._reportLog("20002", t, {
                    ft: n,
                    fs: t.file.size,
                    bu: t.bucket,
                    ok: t.object,
                ...
                var u = {
                    headers: {
                        "x-oss-notification": t.userData ? t.userData : ""
                    },
                    partSize: s
                };
                this._ossUpload.upload(t, u)
            }
        }, {
            key: "_findUploadIndex",
            value: function() {
                for (var t = -1, e = 0; e < this._uploadList.length; e++)
                    if (this._uploadList[e].state == a.UPLOADSTATE.INIT) {
                        t = e;
                        break
                    }
                return t
            ...
            value: function(t, e) {
                if ("cancel" == e.name)
                    try {
                        this.options.onUploadCanceled(t, e)
                    } catch (t) {
                        console.log(t)
                    }
                else {
                    if (e.message.indexOf("InvalidAccessKeyIdError") > 0 || "SignatureDoesNotMatchError" == e.name || "SecurityTokenExpired" == e.code || "InvalidSecurityToken.Expired" == e.code || "InvalidAccessKeyId" == e.code && this._ossCreditor.securityToken) {
                        if (this.options.onUploadTokenExpired) {
                            this._state = a.VODSTATE.EXPIRE,
                            t.state = a.UPLOADSTATE.FAIlURE;
                            try {
                                this.options.onUploadTokenExpired(t, e)
                            } catch (t) {
                                console.log(t)
                            }
                        }
                    ...
                    if (("RequestTimeoutError" == e.name || "ConnectionTimeout" == e.name) && this._retryTotal > this._retryCount) {
                        var n = this;
                        return setTimeout(function() {
                            n._upload(t, !0)
                        }, 1e3 * this._retryDuration),
                        void this._retryCount++
                    }
                    "NoSuchUploadError" == e.name && this._removeCheckoutpoint(t),
                    this._handleError(t, e)
                }
            }
        }, {
            key: "_handleError",
            value: function(t, e) {
                ...
                if (t.state != a.UPLOADSTATE.CANCELED && (t.state = a.UPLOADSTATE.FAIlURE,
                this.options.onUploadFailed && e && e.code && e.message))
                    try {
                        this.options.onUploadFailed(t, e.code, e.message)
                    } catch (t) {
                        console.log(t)
                    }
                var r = a.UPLOADSTATE.FAIlURE;
                if (n && this._changeState(t, r),
                this._reportLog("20006", t, {
                    code: e.name,
                    message: e.message,
                    requestId: e.requestId,
                    fs: t.file.size,
            ...
            key: "_complete",
            value: function(t, e) {
                if (t.state = a.UPLOADSTATE.SUCCESS,
                this.options.onUploadSucceed)
                    try {
                        this.options.onUploadSucceed(t)
                    } catch (t) {
                        console.log(t)
                    }
            ...
            value: function(t, e, n) {
                if (this.options.onUploadProgress)
                    try {
                        this.options.onUploadProgress(t, e.total, e.loaded)
                    } catch (t) {
                        console.log(t)
                    }
                var r = e.checkpoint
                  , i = 0;
                if (r && (t.checkpoint = r,
                this._saveCheckoutpoint(t, r, a.UPLOADSTATE.UPLOADING),
                i = r.uploadId),
                this._retryCount = 0,
                0 != e.loaded && this._reportLog("20007", t),
                100 != e.loaded) {
                    var o = 0;
                    n && n.headers && (o = n.headers["x-oss-request-id"]),
                    this._reportLog("20005", t, {
                        UploadId: i,
                        pn: this._getPortNumber(r) + 1,
                        requestId: o,
                        pr: t.retry ? 1 : 0,
                        fs: t.file.size,
                        bu: t.bucket,
            ...
            value: function(t) {
                var e = this._getCheckoutpointKey(t);
                d.default.remove(e)
            }
        }, {
            ...
            value: function(t, e, n) {
                if (e) {
                    var r = this._getCheckoutpointKey(t)
                      , i = t.file
                      , o = {
                        fileName: i.name,
            ...
            value: function(t, e) {
                ...
                n && this._saveCheckoutpoint(t, n.checkpoint, e)
            }
        }, {
            key: "_getCheckoutpointKey",
            value: function(t) {
                return "upload_" + t.file.lastModified + "_" + t.file.name + "_" + t.file.size
            }
        }, {
            key: "_reportLog",
            value: function(t, e, n) {
            ...
            value: function() {
                ...
                window && (window.onbeforeunload = function(e) {
                    if (-1 != t._curIndex && t._uploadList.length > t._curIndex) {
                        var n = t._uploadList[t._curIndex];
                        t._changeState(n, a.UPLOADSTATE.STOPED)
                    }
                }
                )
            }
            ...
            key: "_initState",
            value: function() {
                for (var t = 0; t < this._uploadList.length; t++)
                    this._uploadList[t].state == a.UPLOADSTATE.FAIlURE && (this._uploadList[t].state = a.UPLOADSTATE.INIT);
                this._state = a.VODSTATE.INIT
            }
        }, {
            key: "_adjustPartSize",
            value: function(t) {
                return t.file.size / this.options.partSize > 5e3 ? t.file.size / 4999 : this.options.partSize
            }
        }]),
        t
    }();
...
, function(t, e, n) {
    ...
    function() {
        ...
        return o(t, [{
            key: "create",
            value: function(t) {
                if (t.endpoint = t.endpoint || this._config.endpoint,
                t.bucket = t.bucket || this._config.bucket,
                !(t.AccessKeyId && t.AccessKeySecret && t.endpoint && t.SecurityToken))
                ...
                this.oss = new OSS.Wrapper({
                    ...
                    endpoint: t.endpoint || this._config.endpoint,
                    bucket: t.bucket || this._config.bucket
                })
            }
        }, {
            key: "abort",
            value: function(t) {
                if (t.checkpoint) {
                    var e = t.checkpoint.uploadId;
                    this.oss.abortMultipartUpload(t.object, e)
                }
            }
        }, {
            key: "cancel",
            ...
            value: function(t, e) {
                ...
                var n = this
                  ...
                  , i = {
                    parallel: e.parallel || this._config.parallel || a.UPLOADDEFAULT.PARALLEL,
                    partSize: e.partSize || this._config.partSize || a.UPLOADDEFAULT.PARTSIZE,
                    progress: r
                };
                e.headers && (i.headers = e.headers),
                t.checkpoint && (i.checkpoint = t.checkpoint),
                t.bucket || (this.oss.options.bucket = t.bucket),
                t.endpoint || (this.oss.options.endpoint = t.endpoint),
                this.oss.multipartUpload(t.object, t.file, i).then(function(t) {
                    n._complete(t)
                }).catch(function(t) {
                    n.oss.cancel && (n.oss && n.oss.isCancel() ? console.log("oss is cancel as error") : n.oss.cancel()),
                    n._error(t)
                })
            }
        }, {
            key: "header",
            value: function(t, e, n) {
                this.oss.get(t.object).then(function(t) {
                    e(t)
                }).catch(function(t) {
                    n(t)
                })
            ...
            key: "_error",
            value: function(t) {
                this._callback.onerror(this._uploadInfo, t)
            }
        }, {
            key: "_complete",
            value: function(t) {
                this._callback.oncomplete(this._uploadInfo, t)
            }
        }]),
        t
    }());
        ...
        return i(t, null, [{
            ...
            value: function(t) {
                if (arguments.length < 2)
                    return null;
                for (var e = arguments[1], n = 1; n < arguments.length; n++) {
                    var r = new RegExp("\\{" + (n - 1) + "\\}","gm");
                    e = e.replace(r, arguments[n + 1])
                }
                return {
                    code: t,
                    message: e
...
, function(t, e, n) {
    ...
    (function(t) {
        ...
        function j(t, e, n, r, i) {
            return i || N(t, e, n, 4, 3.4028234663852886e38, -3.4028234663852886e38),
            Z.write(t, e, n, r, 23, 4),
            n + 4
        }
        function F(t, e, n, r, i) {
            return i || N(t, e, n, 8, 1.7976931348623157e308, -1.7976931348623157e308),
 ...
 */
        ...
        o.prototype.compare = function(t, e, n, r, i) {
            ...
            this === t)
                return 0;
            for (var a = i - r, s = n - e, u = Math.min(a, s), c = this.slice(r, i), f = t.slice(e, n), l = 0; l < u; ++l)
                if (c[l] !== f[l]) {
                    a = c[l],
                    s = f[l];
                    break
...
, function(t, e, n) {
    ...
    function o(t) {
        ...
        for (e = 0; e < n; e += 4)
            ...
            a[u++] = i >> 8 & 255,
            a[u++] = 255 & i;
        return 2 === o ? (i = f[t.charCodeAt(e)] << 2 | f[t.charCodeAt(e + 1)] >> 4,
        a[u++] = 255 & i) : 1 === o && (i = f[t.charCodeAt(e)] << 10 | f[t.charCodeAt(e + 1)] << 4 | f[t.charCodeAt(e + 2)] >> 2,
        a[u++] = i >> 8 & 255,
        a[u++] = 255 & i),
        a
    }
    ...
    e.toByteArray = o,
    e.fromByteArray = u;
    for (var c = [], f = [], l = "undefined" != typeof Uint8Array ? Uint8Array : Array, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", d = 0, p = h.length; d < p; ++d)
        c[d] = h[d],
        f[h.charCodeAt(d)] = d;
    f["-".charCodeAt(0)] = 62,
    f["_".charCodeAt(0)] = 63
...
, function(t, e) {
    ...
    e.write = function(t, e, n, r, i, o) {
        var a, s, u, c = 8 * o - i - 1, f = (1 << c) - 1, l = f >> 1, h = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, d = r ? 0 : o - 1, p = r ? 1 : -1, g = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        for (e = Math.abs(e),
    ...
    var o = function() {
      ...
      , p = function() {
        function t(e) {
            ...
            var f = "pc";
            d.default.os.ipad ? f = "pad" : (d.default.os.iphone || d.default.os.android) && (f = "phone"),
        ...
        return o(t, [{
            key: "log",
            value: function(t, e) {
                e && e.ri ? (this._ri = e.ri,
                delete e.ri) : this._ri = s.default.create(),
                this.initParam.t = (new Date).getTime(),
                this.initParam.ll = "20006" == t ? "error" : "info",
                ...
                for (var r in this.initParam)
                    o.push(r + "=" + this.initParam[r]);
                var a = o.join("&");
                if (console.log(a),
                AliyunUpload && AliyunUpload.__logTestCallback__)
            ...
            key: "getUuid",
            value: function() {
                var t = c.default.get("p_h5_upload_u");
                return t || (t = s.default.create(),
                c.default.set("p_h5_upload_u", t, 730)),
                t
            }
        }]),
        t
        ...
        return i(t, null, [{
            ...
            value: function(t) {
                for (var e = t + "", n = document.cookie.split(";"), r = 0; r < n.length; r++) {
                    var i = n[r].trim();
                    if (0 == i.indexOf(e))
                        return unescape(i.substring(e.length + 1, i.length))
                }
                return ""
            }
        }, {
...
, function(t, e, n) {
    ...
    var i = function() {
      ...
      , o = function(t) {
        ...
        if (t.android)
            return "android";
        if (e.indexOf("Baiduspider") > -1)
            return "Baiduspider";
        if (e.indexOf("PlayStation") > -1)
            return "PS4";
        var r = "Win32" == navigator.platform || "Windows" == navigator.platform || e.indexOf("Windows") > -1
          , i = "Mac68K" == navigator.platform || "MacPPC" == navigator.platform || "Macintosh" == navigator.platform || "MacIntel" == navigator.platform;
        return i && (n = "macOS"),
        "X11" == navigator.platform && !r && !i && (n = "Unix"),
      ...
      , a = function() {
        var t = navigator.userAgent
          , e = "";
        return (t.indexOf("Windows NT 5.0") > -1 || t.indexOf("Windows 2000") > -1) && (e = "2000"),
        (t.indexOf("Windows NT 5.1") > -1 || t.indexOf("Windows XP") > -1) && (e = "XP"),
        (t.indexOf("Windows NT 5.2") > -1 || t.indexOf("Windows 2003") > -1) && (e = "2003"),
        (t.indexOf("Windows NT 6.0") > -1 || t.indexOf("Windows Vista") > -1) && (e = "Vista"),
        (t.indexOf("Windows NT 6.1") > -1 || t.indexOf("Windows 7") > -1) && (e = "7"),
        (t.indexOf("Windows NT 6.2") > -1 || t.indexOf("Windows 8") > -1) && (e = "8"),
        (t.indexOf("Windows NT 6.3") > -1 || t.indexOf("Windows 8.1") > -1) && (e = "8.1"),
        (t.indexOf("Windows NT 10") > -1 || t.indexOf("Windows 10") > -1) && (e = "10"),
        e
    }
      , s = function(t) {
        var e = navigator.userAgent.toLowerCase();
        return t.chrome ? "Chrome" : t.firefox ? "Firefox" : t.safari ? "Safari" : t.webview ? "webview" : t.ie ? /edge/.test(e) ? "Edge" : "IE" : /baiduspider/.test(e) ? "Baiduspider" : /ucweb/.test(e) || /UCBrowser/.test(e) ? "UC" : /opera/.test(e) ? "Opera" : /ucweb/.test(e) ? "UC" : /360se/.test(e) ? "360浏览器" : /bidubrowser/.test(e) ? "百度浏览器" : /metasr/.test(e) ? "搜狗浏览器" : /lbbrowser/.test(e) ? "猎豹浏览器" : /micromessenger/.test(e) ? "微信内置浏览器" : /qqbrowser/.test(e) ? "QQ浏览器" : /playstation/.test(e) ? "PS4浏览器" : void 0
    }
      , u = function() {
        var t = {}
          , e = {}
          ...
          , A = n.match(/PlayBook/)
          , b = n.match(/Chrome\/([\d.]+)/) || n.match(/CriOS\/([\d.]+)/)
          , S = n.match(/Firefox\/([\d.]+)/)
        ...
        if ((e.webkit = !!i) && (e.version = i[1]),
        u && (t.android = !0,
        t.version = u[2]),
        h && !l && (t.ios = t.iphone = !0,
        t.version = h[2].replace(/_/g, ".")),
        f && (t.ios = t.ipad = !0,
        t.version = f[2].replace(/_/g, ".")),
        l && (t.ios = t.ipod = !0,
        t.version = l[3] ? l[3].replace(/_/g, ".") : null),
        g && (t.wp = !0,
        t.version = g[1]),
        d && (t.webos = !0,
        t.version = d[2]),
        ...
        _ && (e.silk = !0,
        e.version = _[1]),
        !_ && t.android && n.match(/Kindle Fire/) && (e.silk = !0),
        b && (e.chrome = !0,
        e.version = b[1]),
        S && (e.firefox = !0,
        e.version = S[1]),
        ...
        I && (e.ie = !0,
        e.version = I[1]),
        U && (c || t.ios || p || u) && (e.safari = !0,
        t.ios || (e.version = U[1])),
        k && (e.webview = !0),
        c) {
            var P = n.match(/[\d]*_[\d]*_[\d]*/);
            P && P.length > 0 && P[0] && (t.version = P[0].replace(/_/g, "."))
        }
        return t.tablet = !!(f || A || u && !n.match(/Mobile/) || S && n.match(/Tablet/) || I && !n.match(/Phone/) && n.match(/Touch/)),
        t.phone = !(t.tablet || t.ipod || !(u || h || d || m || w || b && n.match(/Android/) || b && n.match(/CriOS\/([\d.]+)/) || S && n.match(/Mobile/) || I && n.match(/Touch/))),
        t.pc = !t.tablet && !t.phone,
        c ? t.name = "macOS" : p ? (t.name = "windows",
        t.version = a()) : t.name = o(t),
        e.name = s(e),
        {
            os: t,
            browser: e
      ...
      , c = function() {
        ...
        return i(t, null, [{
            ...
            value: function(t) {
                ...
                var n = t.indexOf("//")
                  , r = t;
                n > -1 && (r = t.substring(n + 2));
                var e = r
                  , i = r.split("/");
                return i && i.length > 0 && (e = i[0]),
                i = e.split(":"),
                i && i.length > 0 && (e = i[0]),
                e
            }
            ...
            get: function() {
                var t = u.browser;
                return t.name || (t.name = this.getBrowserType()),
                t
            }
        }]),
        t
        ...
        return o(t, null, [{
            ...
            value: function(t, e, n) {
                ...
                c.default.randomUUID())
                  ...
                  , o = c.default.makeUTF8sort(i, "=", "&") + "&Signature=" + c.default.aliyunEncodeURI(c.default.makeChangeSiga(i, t.accessKeySecret))
                  , a = "https://vod.cn-shanghai.aliyuncs.com/?" + o;
                s.default.get(a, function(t) {
                    var t = JSON.parse(t);
                    e && e(t)
                }, function(t) {
                    if (n) {
            ...
            value: function(t, e, n) {
                ...
                t.fileSize && (i.FileSize = t.fileSize),
                t.description && (i.Description = t.description),
                t.cateId && (i.CateId = t.cateId),
                t.tags && (i.Tags = t.tags),
                t.templateGroupId && (i.TemplateGroupId = t.templateGroupId);
                var o = c.default.makeUTF8sort(i, "=", "&") + "&Signature=" + c.default.aliyunEncodeURI(c.default.makeChangeSiga(i, t.accessKeySecret))
                  , a = "https://vod.cn-shanghai.aliyuncs.com/?" + o;
                s.default.get(a, function(t) {
                    var t = JSON.parse(t);
                    e && e(t)
            ...
            value: function(t, e, n) {
                ...
                c.default.randomUUID())
                  , i = {
                    ...
                    ImageType: t.imageType ? t.imageType : "default",
                    Version: "2017-03-21",
                    Format: "JSON",
                    SignatureMethod: "HMAC-SHA1",
                    SignatureVersion: "1.0",
                ...
                t.imageExt && (i.ImageExt = t.imageExt),
                t.tags && (i.Tags = t.tags);
                var o = c.default.makeUTF8sort(i, "=", "&") + "&Signature=" + c.default.aliyunEncodeURI(c.default.makeChangeSiga(i, t.accessKeySecret))
                  , a = "https://vod.cn-shanghai.aliyuncs.com/?" + o;
                s.default.get(a, function(t) {
        ...
        return i(t, null, [{
            ...
            value: function(t, e, n, r, i) {
                ...
                o.onreadystatechange = function() {
                    4 === o.readyState && (200 === o.status ? e(o.responseText) : n(o.responseText))
                }
                ;
                try {
                    void 0 === r && (r = !0),
    ...
    function() {
        ...
        return i(t, null, [{
            ...
            value: function(t) {
                ...
                return e = e.replace(/\+/g, "%20").replace(/\*/g, "%2A").replace(/%7E/g, "~").replace(/!/g, "%21").replace(/\(/g, "%28").replace(/\)/g, "%29").replace(/'/g, "%27")
            }
        }, {
            key: "makeUTF8sort",
            value: function(e, n, r) {
                ...
                for (var a = i.sort(), s = "", u = a.length, o = 0; o < u; o++) {
                    var c = t.aliyunEncodeURI(a[o])
                      , f = t.aliyunEncodeURI(e[a[o]]);
                    "" == s ? s = c + n + f : s += r + c + n + f
                }
                return s
            }
            ...
            value: function(e, n) {
                if (!e)
                    throw new Error("PrismPlayer Error: vid should not be null!");
                return a.stringify(o("GET&" + t.aliyunEncodeURI("/") + "&" + t.aliyunEncodeURI(t.makeUTF8sort(e, "=", "&")), n + "&"))
            }
        }]),
        t
    }());
            ...
            o.Base64 = {
                stringify: function(t) {
                    ...
                    for (var i = [], o = 0; o < n; o += 3)
                        for (var a = e[o >>> 2] >>> 24 - o % 4 * 8 & 255, s = e[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255, u = e[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255, c = a << 16 | s << 8 | u, f = 0; f < 4 && o + .75 * f < n; f++)
